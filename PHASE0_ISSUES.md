...
- Pure, unit-tested **executor** that walks nodes/edges and emits "intended actions" (a log of what _would_ happen), including delay + branch resolution given a mocked event.
