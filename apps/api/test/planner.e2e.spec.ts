...
const goodGraph = (prompt: string) => ({
  ...
  nodes: [
    ...
    },
    {
      ...
      type: "step",
      channel: "email",
      content: { body: "Value first, {{firstName}}.", threaded: true },
    },
    {
      id: "step-ack",
      type: "step",
      channel: "email",
      content: { body: "Understood — later then.", threaded: true },
    },
    {
      id: "step-referral",
      type: "step",
      channel: "email",
      content: { body: "Who should I ask?", threaded: true },
    },
    {
      id: "step-answer",
      type: "step",
    ...
    },
    {
      ...
      type: "step",
      channel: "email",
      content: { body: "All good — door's open.", threaded: true },
    },
    { id: "end-won", type: "end" },
