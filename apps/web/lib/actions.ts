...
const ACTION_GROUPS: Record<
  (typeof ACCOUNT_ACTION_KINDS)[number],
...
> = {
  ...
  notify_team: {
    group: "Notify the team",
    desc: "Slack post when connected · always a run row + Logs entry",
  },
  ...
  send_booking_link: {
    group: "Meetings",
    desc: "Queues your booking link into the next composed message",
  },
  // INT W3 (DEC-095): the payment twin (never a send path) + the signed POST.
  send_payment_link: {
    group: "Revenue & CRM",
    desc: "Queues your payment link into the next composed message",
  },
  send_webhook: {
    group: "Flow & integrations",
    desc: "Signed POST to your endpoint · run row records delivery",
  },
 ...
 */
export const ACCOUNT_ACTION_OPTIONS: readonly ActionOption[] = ACCOUNT_ACTION_KINDS.map((kind) => ({
  kind,
...
export const ABSENT_ACTIONS: ReadonlyArray<import("./triggers").AbsentPickerEntry> = [
  ...
  },
  {
    ...
    desc: "Message on LinkedIn",
    reason: SEND_BOUNDARY_REASON,
  },
  {
    group: "Sequences & campaigns",
    icon: "↪",
    label: "Enroll in campaign",
    desc: "Add to a campaign",
    reason: "Arrives with auto-enrollment",
  },
  {
    group: "Sequences & campaigns",
    icon: "↪",
    label: "Move to sequence",
    desc: "Restart in another sequence",
    reason: CAMPAIGN_SCOPED_REASON,
  },
  {
    group: "Sequences & campaigns",
    icon: "⑃",
    label: "Move to branch",
    desc: "Jump to a branch",
    reason: CAMPAIGN_SCOPED_REASON,
  },
  {
    group: "Sequences & campaigns",
    icon: "⏭",
    label: "Skip to step",
    desc: "Jump ahead in the sequence",
    reason: CAMPAIGN_SCOPED_REASON,
  },
  {
    group: "Update the lead",
    icon: "⌫",
    label: "Remove tag",
    desc: "Take a tag off the contact",
    reason: "Arrives with tag management",
  },
  {
    group: "Update the lead",
    icon: "☰",
    label: "Add to list",
    desc: "Put the contact on a list",
    reason: "Arrives with list actions",
  },
  {
    group: "Update the lead",
    icon: "☰",
    label: "Remove from list",
    desc: "Take the contact off a list",
    reason: "Arrives with list actions",
  },
  {
    group: "Update the lead",
  ...
  },
  {
    ...
    icon: "▦",
    label: "Update field",
    desc: "Set a contact field",
    reason: "Arrives with field actions",
  },
  {
    group: "Update the lead",
    icon: "⚯",
    label: "Enrich lead data",
    desc: "Append fresh data",
  ...
  },
  {
    ...
    desc: "Route to a person",
    reason: "Arrives with teammates & tasks",
  },
  {
    group: "Assign & tasks",
    icon: "◎",
    label: "Assign to agent",
    desc: "Route to an agent",
    reason: "Arrives with teammates & tasks",
  },
  {
    group: "Assign & tasks",
  ...
  // Clientforce-created bookings + the gcal events scope.
  {
    group: "Meetings",
    icon: "⏰",
    label: "Send meeting reminder",
    desc: "Nudge before the meeting",
    reason:
  ...
  // renumbered from Q-046 — see PROGRESS).
  {
    group: "Notify the team",
    icon: "✉",
    label: "Email internal alert",
    desc: "Email the team",
    reason: "Arrives with email alerts",
  },
  {
    group: "Flow & integrations",
    icon: "⏱",
    label: "Wait",
    desc: "Pause between actions",
    reason: "Multi-step chains arrive with automations v2",
  },
  {
    group: "Flow & integrations",
    icon: "⏰",
    label: "Wait until time",
    desc: "Hold until a set time",
    reason: "Multi-step chains arrive with automations v2",
  },
  ...
  // (Q-044's send half; the incoming trigger + Zapier/Sheets re-file → Q-054).
  {
    group: "Flow & integrations",
    icon: "⚡",
    label: "Trigger Zapier / Make",
    desc: "Hand off to a zap",
    reason: "Arrives with the Zapier integration",
  },
  {
    group: "Flow & integrations",
    icon: "▦",
    label: "Add row to Google Sheet",
    desc: "Append a spreadsheet row",
    reason: "Arrives with the Google Sheets integration",
  },
];
