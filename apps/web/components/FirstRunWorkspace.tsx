      ...
      >
        ...
        <input
          ...
          style={{
            ...
            height: 46,
            borderRadius: 12,
            border: `1px solid ${error ? "#E0796B" : "#EBE3D6"}`,
            padding: "0 14px",
            fontSize: 14.5,
            color: "#0E1512",
        ...
        {error ? (
          <div
            style={{ fontSize: 12.5, color: "#C9543F", fontWeight: 600, marginTop: 8 }}
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 12,
            border: "none",
            background: valid && !busy ? GRAD : "#ECE7DC",
            color: valid && !busy ? "#0A0F0C" : "#9AA59E",
            fontWeight: 700,
            fontSize: 15,
            fontFamily: "'Hanken Grotesk',sans-serif",
            cursor: valid && !busy ? "pointer" : "not-allowed",
            boxShadow: valid && !busy ? "0 6px 16px rgba(53,232,52,.26)" : "none",
          }}
