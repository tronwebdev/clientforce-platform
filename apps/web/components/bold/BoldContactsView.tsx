...
export function contactTag(
  row: BoldContactRow,
): "Customer" | "Booked" | "Prospect" | "Unsubscribed" {
...
export function BoldContactsView({
  ...
  const valueOf = (r: BoldContactRow) =>
    r.valueEstCents != null && (r.stage === "booked" || r.stage === "won")
      ? money(r.valueEstCents)
      : "—";
  ...
  if (rows === null) {
    return (
      <div style={{ padding: "26px 40px 40px" }} data-testid="bold-contacts">
        <div style={{ ...mono, fontSize: 10, letterSpacing: ".13em", color: "var(--cvb-faint)" }}>
          LOADING CONTACTS
        </div>
      </div>
    );
      ...
      >
        ...
        >
          ...
          {query ? (
            <span
              onClick={() => setQuery("")}
              style={{ fontSize: 12, color: "var(--cvb-faint)", cursor: "pointer", flex: "none" }}
            >
              ✕
            </span>
          ) : null}
          ...
          {(
            ...
            <span
              ...
              style={{
                ...
                cursor: "pointer",
                background: grid === g ? "var(--cvb-card)" : "transparent",
                color: grid === g ? "var(--cvb-ink)" : "var(--cvb-faint)",
                fontSize: 13,
              }}
            >
              {ic}
              ...
              >
                ...
                <div
                  style={{
                    ...mono,
                    fontSize: 10,
                    color: r.phone ? "var(--cvb-muted)" : "var(--cvb-ghost)",
                    marginTop: 3,
                    whiteSpace: "nowrap",
                  }}
                >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 13 }}>
                  ...
                  <span style={{ flex: 1 }} />
                  <span
                    style={{ ...mono, fontSize: 10, color: "var(--cvb-faint)" }}
                    title="The campaign’s per-win estimate — potential, not a payment"
                  >
                    {valueOf(r)}
                  </span>
                </div>
        ...
        <div style={{ marginTop: 18 }}>
          <div
            style={{
              ...
              gap: 12,
              padding: "0 8px 9px",
              borderBottom: "1px solid var(--cvb-line)",
            }}
          >
        ...
        <div style={{ textAlign: "center", padding: "56px 20px" }} data-testid="bold-ct-empty">
          {query ? (
            <>
              <div
                className="cvb-display"
                style={{ fontWeight: 900, fontSize: 18, letterSpacing: "-.028em" }}
              >
                Nobody matches “{query}”
              </div>
              <div
                style={{ fontSize: 13, color: "var(--cvb-faint)", lineHeight: 1.55, marginTop: 8 }}
              >
