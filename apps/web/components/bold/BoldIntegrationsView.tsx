                      ...
                      {chip ? (
                        ...
                        <span
                          style={{
                            ...
                            background: "var(--cvb-cyan-tint,#E2F3F6)",
                            border: "1px solid var(--cvb-cyan-line,#BFE3EB)",
                            borderRadius: 999,
                            padding: "3px 8px",
                            flex: "none",
                          }}
      ...
      {open ? (
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <span
                style={{
                  ...
                  borderRadius: 14,
                  flex: "none",
                  background: TILE[open.tile].tilebg,
                  color: TILE[open.tile].tilefg,
                  display: "grid",
                  placeItems: "center",
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  ...
                  {statuses?.get(open.id)?.status?.toUpperCase() ??
                    (open.availability.kind === "live" ? "NOT CONNECTED" : "ON ITS WAY")}
                </div>
              </div>
              <span
                onClick={() => setOpen(null)}
            ...
            <div
              style={{ fontSize: 13, color: "var(--cvb-muted)", lineHeight: 1.6, marginTop: 16 }}
            >
              {open.desc}
            </div>
            ...
            {open.availability.kind === "live" ? (
              <div
                data-testid="bold-int-classic-pointer"
                style={{
                  marginTop: 20,
