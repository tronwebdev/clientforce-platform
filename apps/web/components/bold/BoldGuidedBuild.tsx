...
const FORM_STEPS: Step[] = [
  {
    ...
    options: [
      {
        name: "Take bookings",
        sub: "A time-and-details form — responses can join a campaign",
        value: "booking",
      },
      {
        name: "Answer enquiries",
        sub: "Questions land as contacts you can work",
        value: "enquiry",
      },
  ...
  },
  {
    ...
    options: [
      {
        name: "Name, phone, what they need",
        sub: "Three fields — highest completion",
        value: "lean",
      },
      {
        name: "Add email and preferred time",
        sub: "Five fields — better routing",
        value: "fuller",
      },
    ...
    options: [
      {
        ...
        sub: "Everything else optional — highest completion",
        value: "lean",
      },
      {
        name: "Name, phone and what they need",
        sub: "One more required field, better routing",
        value: "mid",
      },
...
const AUTO_STEPS: Step[] = [
  {
    ...
    options: [
      ...
      {
        name: "A price objection arrives",
        sub: "A reply classified as an objection",
        value: "objection",
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        name: "Tag the contact",
        sub: 'Adds the tag "follow-up" — rename it any time',
        value: "add_tag",
      },
      {
        name: "End their campaign",
        sub: "Stops the sequence for that contact",
        value: "end_enrollment",
      },
    ],
  },
  {
...
export function BoldGuidedBuild({
        ...
        s.label === "WHERE LEADS LAND"
          ? {
              ...
              options: [
                ...
                {
                  name: "No campaign — just a contact",
                  sub: "You decide later, in Where it goes",
                  value: "none",
                },
              ],
            }
    ...
    try {
      if (kind === "form") {
          ...
          ...(fieldsV !== "lean"
            ? [
                { key: "email", label: "Email", type: "email", required: reqV === "all" },
                {
                  ...
                  type: "choice",
                  required: reqV === "all",
                  options: ["Mornings", "Afternoons", "Any"],
                },
              ]
            : []),
          ...(fieldsV === "richest"
        ...
        const res = await createForm({
          ...
          intro,
          submitLabel:
            kindV === "booking" ? "Book it" : kindV === "waitlist" ? "Join the list" : "Send it",
          fields,
          routing: {
            tag: "from-form",
  ...
  const locus =
    kind === "form" ? "Ada · forms" : kind === "proposal" ? "Ada · proposals" : "Ada · automations";
  const doneCta =
    kind === "form"
      ? "Open the form"
      : kind === "proposal"
  ...
  return (
    <>
      <div
        onClick={onClose}
        style={{ position: "fixed", inset: 0, background: "var(--cvb-scrim)", zIndex: 80 }}
      />
      <div
        data-testid="bold-gb"
        style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "16px 20px 12px" }}>
          <span
            style={{
              ...
              borderRadius: 10,
              background:
                "var(--cvb-gradient-signature, linear-gradient(135deg,#36D7ED,#35E834 55%,#D0F56B))",
              flex: "none",
            }}
          />
          <div style={{ flex: 1 }}>
            ...
            <div
              style={{ ...mono, fontSize: 9, letterSpacing: ".14em", color: "var(--cvb-ghost)" }}
            >
              {locus.toUpperCase()}
            </div>
          </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "4px 20px 20px" }}>
          ...
          {built ? (
            ...
            >
              ...
              <div
                style={{ fontSize: 11.5, color: "var(--cvb-faint)", marginTop: 6, lineHeight: 1.5 }}
              >
                {kind === "form"
              ...
              <div style={{ display: "flex", gap: 8, marginTop: 14 }}>
                <span
                  onClick={() => onDone(kind, built.id)}
                  data-testid="bold-gb-open"
                  style={{
                    fontSize: 12.5,
                    fontWeight: 800,
                    color: "#fff",
            ...
            <div>
              ...
              {step.options
                ? step.options.map((o, oi) => (
                    <div
                      key={o.value}
                      onClick={() => answer(o.name, o.value)}
                      data-testid={`bold-gb-opt-${oi}`}
                      style={{
                        background: "var(--cvb-panel)",
                        border: "1px solid var(--cvb-line-ctl)",
                        borderRadius: 16,
              ...
              {step.input ? (
                <div style={{ display: "flex", gap: 8 }}>
                  ...
                  <span
                    onClick={() =>
                      inputVal.trim() && !busy && answer(inputVal.trim(), inputVal.trim())
                    }
