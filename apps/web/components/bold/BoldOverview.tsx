...
export function BoldOverview({
  ...
  const heroValue =
    meta.heroMode === "money" && monetary && completions > 0
      ? money(est * completions)
      : String(completions);
  ...
  const saveValue = useCallback(async () => {
    ...
    if (
      (estCents != null && !Number.isFinite(estCents)) ||
      ...
      onOpenDrawer({
        ...
        rows: [
          ...
          ...(target
            ? [
                {
                  n: `To go (${Math.max(0, target - completions)})`,
                  v: money(remaining),
    ...
    <div style={{ padding: "26px 40px 40px" }}>
      ...
      {needs.length > 0 ? (
        <div
          ...
          style={{
            ...
            border: "1px solid var(--cvb-amber-line, #EFE6CF)",
            borderRadius: 13,
            padding: "11px 14px",
            marginBottom: 14,
            cursor: "pointer",
        ...
        >
          ...
          <span style={{ fontSize: 12, fontWeight: 700, color: "var(--cvb-forest)", flex: "none" }}>
            Review →
          </span>
        </div>
      ) : null}
      ...
      <div
        ...
        style={{
          ...
          borderRadius: 22,
          animation: "cvb-rise .45s var(--cvb-ease) both",
        }}
      >
        <div
          style={{
        ...
        >
          ...
          >
            <div style={{ flex: 1, minWidth: 190 }}>
              ...
              >
                {goalSentence(agent.goal, agent.goalSummary)}
              </div>
              <div
                  ...
                  >
                    <span
                      style={{
                        ...
                        animation: "cvb-grow .8s var(--cvb-ease) .15s both",
                      }}
                    />
                  </div>
                  <div
          ...
          {stats.map((m, i) => (
            <div
              ...
              style={{
                ...
                minWidth: 0,
                padding: "18px 16px",
                borderLeft: `1px solid ${i === 0 ? "transparent" : "var(--cvb-line-inner)"}`,
                cursor: "pointer",
              }}
            >
              <div
              ...
              <div
                style={{
                  fontSize: 11,
                  fontWeight: 500,
                  color: m.fg === "var(--cvb-forest)" ? "var(--cvb-forest)" : "var(--cvb-faint)",
                  marginTop: 8,
                  lineHeight: 1.35,
                }}
              >
      ...
      <div
        data-tour="act"
        style={{ display: "flex", alignItems: "center", gap: 12, margin: "38px 0 16px" }}
      >
        <span
          style={{
            width: 7,
        ...
        >
          <span
            style={{
              ...
              inset: -4,
              borderRadius: "50%",
              border: "2px solid var(--cvb-forest)",
              animation: "cvb-glow 1.8s ease-out infinite",
            }}
          />
        </span>
        ...
        <span
          onClick={onAllActivity}
          data-testid="bold-all-activity"
          style={{ fontSize: 12, fontWeight: 700, color: "var(--cvb-cyan)", cursor: "pointer" }}
        >
          All activity →
        </span>
      </div>
      ...
      {liveRow && liveComposed ? (
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
              <span style={{ fontWeight: 800, fontSize: 16, letterSpacing: "-.024em" }}>
                {contactName(liveRow.contact)}
              </span>
              <span
                style={{
                  fontSize: 10,
            ...
            <div
              style={{ fontSize: 14, color: "var(--cvb-ink-soft)", lineHeight: 1.5, marginTop: 7 }}
            >
              {liveComposed.body}
            </div>
          </div>
          <div style={{ textAlign: "right", flex: "none" }}>
            ...
            <div style={{ ...mono, fontSize: 10, color: "var(--cvb-faint)", marginTop: 5 }}>
              {relTime(liveRow.occurredAt)}
            </div>
          </div>
        </div>
      ) : null}
      ...
      <div style={{ marginTop: 6 }} data-testid="bold-feed">
        {feed == null ? (
          <div style={{ fontSize: 12.5, color: "var(--cvb-faint)", padding: "18px 6px" }}>
            Loading activity…
          </div>
        ) : null}
        {feed
          ?.filter((r) => r.id !== liveRow?.id)
          .slice(0, 6)
          .map((r) => (
        ...
        {feed != null && feed.length === 0 ? (
          <div style={{ textAlign: "center", padding: "40px 20px" }}>
            <div style={{ fontWeight: 700, fontSize: 15, color: "var(--cvb-muted)" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 5 }}>
          ...
          <span style={{ ...mono, fontSize: 10, color: "var(--cvb-faint)" }}>
            {relTime(row.occurredAt)}
          </span>
        </div>
      </div>
      {c.value ? (
        <span style={{ ...mono, fontSize: 11, color: "var(--cvb-forest)", flex: "none" }}>
          {c.value}
        </span>
      ) : null}
    </div>
