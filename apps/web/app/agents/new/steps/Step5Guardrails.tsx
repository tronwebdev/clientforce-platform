      ...
      <div style={{ maxWidth: 820 }}>
        ...
        {senders.length > 0 ? (
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                Email channel ready to send
              </div>
              <div style={{ fontSize: 12.5, color: "#5C6B62" }}>
                Every step in your sequence has a connected, healthy sender.
              </div>
            </div>
          </div>
        ) : (
          <div
            style={{
              ...
              border: "1px solid rgba(232,196,91,.5)",
              borderRadius: 14,
              padding: "15px 18px",
              marginBottom: 12,
            }}
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                Email channel not ready
              </div>
              <div style={{ fontSize: 12.5, color: "#5C6B62" }}>
                Connect Email below before this agent can launch.
              </div>
            </div>
          </div>
        )}
        ...
        >
          ...
          {senders.length === 0 ? (
            ...
            senders.map((s) => {
              ...
              const pct = Math.min(
                100,
                Math.round((s.sentToday / Math.max(1, s.dailyLimit)) * 100),
              );
              const active = s.status === "ACTIVE";
              return (
                <div
                  key={s.id}
                  style={{ borderTop: "1px solid #F2EEE4", padding: "15px 18px" }}
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 13 }}>
                    ...
                    <span
                      style={{
                        fontSize: 11,
                        fontWeight: 700,
                        color: active ? "#0F7A28" : "#A87B16",
                        background: active ? "#D7F5DD" : "rgba(232,196,91,.18)",
                        borderRadius: 7,
                        padding: "5px 10px",
                        flex: "none",
                      }}
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                        <span
                          style={{
                            ...
                            height: 9,
                            borderRadius: "50%",
                            background: active ? "#16A82A" : "#E8C45B",
                          }}
                        />
                        <span style={{ fontSize: 13.5, fontWeight: 700, color: "#0E1512" }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        ...
                        <span style={{ fontSize: 11.5, fontWeight: 600, color: "#5C6B62" }}>
                          {s.sentToday.toLocaleString()} / {s.dailyLimit.toLocaleString()}
                        </span>
                      </div>
                      <div
                        style={{
                      ...
                      >
                        <div
                          style={{
                            ...
                            width: `${pct}%`,
                            borderRadius: 100,
                            background: healthy ? "#16A82A" : "#E8C45B",
                          }}
                        />
                      </div>
                    </div>
        ...
        >
          ...
          <div style={{ fontSize: 12.5, color: "#9AA59E", marginTop: 2, marginBottom: 16 }}>
            The agent only sends inside this window — replies are still handled 24/7.
          </div>
              ...
              {tzOpen ? (
                <div
                  style={{
                    ...
                    border: "1px solid #EBE3D6",
                    borderRadius: 12,
                    boxShadow: "0 12px 32px rgba(14,21,18,.12)",
                    zIndex: 30,
                    maxHeight: 264,
                    overflowY: "auto",
                  }}
                  ...
                  {TZ_OPTIONS.map((t) => (
                    <div
                      ...
                      style={{
                        ...
                        color: "#0E1512",
                        cursor: "pointer",
                        background: timezone === t.zone ? "rgba(53,232,52,.07)" : "#fff",
                      }}
                      data-testid={`tz-opt-${t.zone.replace("/", "-")}`}
                    >
                      <span style={{ color: "#9AA59E", fontSize: 12.5, flex: "none" }}>
                        ({t.offset})
                      </span>
                      {t.label}
                      {timezone === t.zone ? (
                        <span style={{ marginLeft: "auto", color: "#16A82A", fontWeight: 700 }}>
                          ✓
                        </span>
                      ) : null}
                    </div>
          ...
          <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
            {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((label, i) => {
              ...
              return (
                <span
                  key={label}
                  onClick={() => setSendDays((d) => d.map((v, j) => (j === i ? !v : v)))}
                  style={{
                    flex: 1,
                    textAlign: "center",
                    fontSize: 13,
                    ...
                    padding: "9px 0",
                    borderRadius: 10,
                    background: on ? "#0E1512" : "#fff",
                    color: on ? "#fff" : "#9AA59E",
                    border: `1px solid ${on ? "#0E1512" : "#EBE3D6"}`,
                    cursor: "pointer",
                  }}
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: 12, color: "#8A7F6B" }}>
                Hold queued messages overnight &amp; on weekends instead of sending late.
              </div>
            </div>
            <GradToggle
              on={quietHours}
        ...
        >
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: 13.5, fontWeight: 600, color: "#0E1512" }}>
                Gradually ramp send volume
              </div>
              <div style={{ fontSize: 12, color: "#8A7F6B" }}>
                Warm-up-safe — increases daily volume slowly to protect new senders.
              </div>
            </div>
        ...
        <div
          style={{
            ...
            alignItems: "center",
            gap: 14,
            background: "linear-gradient(90deg,rgba(53,232,52,.12),rgba(54,215,237,.08))",
            border: "1px solid rgba(53,232,52,.28)",
            borderRadius: 14,
            padding: "15px 18px",
            marginBottom: 18,
          }}
        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: 12.5, color: "#5C6B62" }}>
              Your sequence meets outreach regulations for the regions you&apos;re targeting.
            </div>
          </div>
        ...
        >
          <div style={{ padding: "16px 20px 4px" }}>
            ...
            <div style={{ fontSize: 12.5, color: "#9AA59E", marginTop: 2 }}>
              How contacts opt out, and who the agent must never message.
            </div>
          </div>
          {[
            {
              icon: "✉",
              label: "One-click unsubscribe footer",
              desc: "Appended to every email — CAN-SPAM & GDPR compliant.",
            },
            {
              icon: "🚫",
              label: "Honor suppression list",
              desc: "Never contact addresses on your workspace suppression list.",
            },
            {
              icon: "⛔",
              label: "Respect opt-outs",
              desc: "Skip contacts who opted out and auto-suppress anyone who unsubscribes.",
            },
          ].map((c) => (
            <div
              key={c.label}
        ...
        <Modal onClose={() => setLimitsOpen(false)} title="Volume & limits" tid="limits-modal">
          ...
          >
            <LimitCard
              ...
              onMinus={() => setDailyCap((v) => Math.max(10, v - 10))}
              onPlus={() => setDailyCap((v) => v + 10)}
              tid="cap"
            />
            {/* P2.1 (DEC-061): per-channel sms cap (guardrails dailyCap.sms) */}
            <LimitCard
              label="Daily SMS cap"
              value={String(smsDailyCap)}
              onMinus={() => setSmsDailyCap((v) => Math.max(10, v - 10))}
              onPlus={() => setSmsDailyCap((v) => v + 10)}
              tid="sms-cap"
            />
          </div>
          <div
          ...
          >
            <LimitCard
              ...
              value={windowStart}
              onMinus={() => setWindowStart(shiftH(windowStart, -1))}
              onPlus={() => setWindowStart(shiftH(windowStart, 1))}
              tid="start"
            />
            <LimitCard
              label="Window end (UTC)"
              value={windowEnd}
              onMinus={() => setWindowEnd(shiftH(windowEnd, -1))}
              onPlus={() => setWindowEnd(shiftH(windowEnd, 1))}
              tid="end"
            />
          </div>
          <div style={{ fontSize: 12, color: "#9AA59E", marginBottom: 14 }}>
            Unsubscribe footer and suppression checks are always on — they can&apos;t be disabled.
          </div>
