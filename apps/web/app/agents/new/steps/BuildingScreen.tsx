...
export function BuildingScreen({
  ...
  const subline = buildDone
    ? "Opening your sequence designer…"
    : `Step ${Math.min(bp + 1, BSTEPS.length)} of ${BSTEPS.length} — analysing goal, knowledge & compliance`;
  ...
  const waitDays = graph
    ? mainPath(graph).reduce(
        (acc, n) => (n.type === "delay" ? acc + (n.unit === "days" ? n.amount : 0) : acc),
        0,
      )
    : 0;
  ...
  const discovered = [
    {
      ...
      value: sources.length
        ? `${sources.length} source${sources.length > 1 ? "s" : ""} · ${ready} ready`
        : "No sources added — using your answers",
    },
    {
      show: bp >= 2,
      icon: "🎯",
      label: "Audience",
      value: fieldVal("target_audience") ?? fieldVal("audience") ?? "From your business context",
    },
    ...
    { show: bp >= 4, icon: "📡", label: "Channels", value: "Email" },
    {
      ...
      icon: "✍",
      label: "Lead hook",
      value: fieldVal("offer") ?? fieldVal("value_proposition") ?? "Personalised per contact",
    },
    {
      show: bp >= 6,
      icon: "📊",
      label: "Deliverability",
      value: "Suppression & unsubscribe checks enforced",
    },
    {
      show: bp >= 7 && stepCount > 0,
      icon: "⏱",
      label: "Cadence",
      value: `${stepCount} steps over ${waitDays} days · Optimal send times`,
    },
    {
      show: bp >= 8 && stepCount > 0,
      icon: "🚀",
      label: "Sequence",
      value: `${stepCount}-step email sequence generated`,
    },
  ];
  return (
    <div
    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: 28 }}>
        <div
          style={{
            ...
            color: "#0A0F0C",
            margin: "0 auto 20px",
            animation: "cfBuildPulse 1.9s ease-in-out infinite",
          }}
        >
          f
        </div>
      ...
      <div style={{ marginBottom: 26 }}>
        ...
        >
          <div
            style={{
              height: "100%",
              borderRadius: 100,
              background: "linear-gradient(90deg,#36D7ED,#35E834 60%,#D0F56B)",
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <span style={{ fontSize: 11.5, fontWeight: 600, color: "#9AA59E" }}>
            {bp} of {BSTEPS.length} steps complete
          </span>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    padding: "9px 12px",
                    borderRadius: 11,
                    background: active ? "rgba(53,232,52,.08)" : "transparent",
                  }}
                >
                  <div
                    style={{
                      ...
                      borderRadius: 9,
                      flex: "none",
                      background: done ? "#D7F5DD" : active ? "rgba(53,232,52,.22)" : "#F2EEE4",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      fontSize: 14,
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div
                      style={{
                        ...
                        color: active ? "#0E1512" : done ? "#3B463F" : "#9AA59E",
                        lineHeight: 1.3,
                      }}
                    >
                      {s.label}
                  ...
                  <span
                    style={{
                      fontSize: 11.5,
                      fontWeight: 700,
                      color: done ? "#16A82A" : active ? "#1192A6" : "transparent",
                      whiteSpace: "nowrap",
                      minWidth: 56,
                      textAlign: "right",
                    }}
              ...
              .map((d) => (
                <div
                  ...
                  style={{
                    ...
                    animation: "cfReveal .28s ease both",
                  }}
                >
                  ...
                  <div style={{ minWidth: 0 }}>
                    ...
                    <div
                      style={{ fontSize: 12.5, fontWeight: 600, color: "#0E1512", lineHeight: 1.4 }}
                    >
                      {d.value}
                    </div>
                  </div>
          ...
          {bp >= 3 ? (
            <div
              style={{
                ...
                flexDirection: "column",
                gap: 6,
                animation: "cfReveal .3s ease both",
              }}
            >
              {[
                "CAN-SPAM guidelines applied",
                "GDPR & CASL compliant",
                "Opt-out & unsubscribe flow ready",
              ].map((t) => (
                <div
                  key={t}
                  style={{
