...
const INBOUND_DEFS = [
  {
    ...
    desc: "Embeds the agent as a chatbot — captures, qualifies & books on-site, then routes leads to this campaign.",
    emptyLabel: "No saved widgets yet",
    createHref: "/widget",
    createLabel: "＋ Create new — Agent Widget",
  },
  {
    key: "form",
    icon: "🔗",
    label: "Hosted form link",
    desc: "A branded form that captures leads and routes them straight to this campaign.",
    emptyLabel: "No saved forms yet",
    createHref: "/forms",
    createLabel: "＋ Create new — Forms",
  },
  {
    key: "embed",
    icon: "⧉",
    label: "Embed on website",
    desc: "An inline form embedded on your site that routes captured leads to this campaign.",
    emptyLabel: "No saved forms yet",
    createHref: "/forms",
    createLabel: "＋ Create new — Forms",
  },
...
const apLabel: React.CSSProperties = {
  fontSize: 11,
  fontWeight: 700,
  color: "#8A7F6B",
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div
          ...
          data-testid="capture-master-card"
        >
          <div
            style={{
              display: "flex",
          ...
          >
            <div>
              <div style={{ fontSize: 15, fontWeight: 700, color: "#0E1512" }}>
                Enable lead capture
              </div>
              <div style={{ fontSize: 13, color: "#8A7F6B" }}>
                Auto-prospect new leads and collect inbound interest into this campaign.
              </div>
            </div>
            <span
              onClick={() => setCapture((c) => ({ ...c, enabled: !c.enabled }))}
              style={{
                width: 48,
                height: 28,
                borderRadius: 100,
              ...
              data-testid="capture-master-toggle"
            >
              <span
                style={{
                  position: "absolute",
                  top: 3,
                  ...(capture.enabled ? { right: 3 } : { left: 3 }),
                  width: 22,
                  height: 22,
                  borderRadius: "50%",
                  background: "#fff",
        ...
        <div
          style={{ display: "flex", flexDirection: "column", gap: 16, ...dim }}
          data-testid="capture-body-left"
        >
          {/* auto-prospecting */}
          <div
            style={{
              background: "#fff",
              border: apOn ? "2px solid #35E834" : "1px solid #EBE3D6",
              borderRadius: 16,
              padding: 20,
              boxShadow: "0 4px 16px rgba(14,21,18,.04)",
            }}
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
              ...
              <div style={{ flex: 1, minWidth: 0, display: "flex", alignItems: "center", gap: 8 }}>
                ...
                {existingAudience ? (
                  <span
                    ...
                    data-testid="ap-badge-not-typical"
                  >
                    Not typical for this goal
                  </span>
                ) : (
                  <span
                    style={{
                    ...
                    data-testid="ap-badge-recommended"
                  >
                    Recommended
                  </span>
                )}
              ...
              <span
                onClick={() => setCapture((c) => ({ ...c, ap: !apOn }))}
                style={{
                  width: 48,
                  height: 28,
                  borderRadius: 100,
            ...
            <div
              style={{
                ...
                color: "#5C6B62",
                lineHeight: 1.5,
                marginBottom: apOn || fitNote ? 16 : 0,
              }}
            >
              Your agent uses live signals to find matching leads and pull them into this campaign
              on demand.
            </div>
            ...
            {fitNote ? (
              <div
                style={{
                  ...
                  borderRadius: 11,
                  padding: "10px 13px",
                  marginBottom: apOn ? 16 : 0,
                }}
                data-testid="ap-fit-note"
              >
                <span style={{ fontSize: 15, flex: "none" }}>{fitNote.icon}</span>
                <div style={{ minWidth: 0 }}>
                  <div style={{ fontSize: 12.5, fontWeight: 700, color: "#0E1512" }}>
                    {fitNote.title}
                  </div>
                  <div style={{ fontSize: 12, color: "#8A7F6B", lineHeight: 1.45 }}>
                    {fitNote.line}
                  </div>
                </div>
              </div>
                    ...
                    >
                      ...
                      <span
                        onClick={() =>
                          setCapture((c) => ({
                            ...c,
                            apKeywords: c.apKeywords.filter((x) => x !== k),
                          }))
                        }
                  ...
                  {apAddOpen ? (
                    <div
                      style={{
                        ...
                        border: "1px solid #EBE3D6",
                        borderRadius: 12,
                        boxShadow: "0 12px 30px rgba(14,21,18,.16)",
                        zIndex: 18,
                        overflow: "hidden",
                        minWidth: 230,
                      }}
                      data-testid="ap-suggestions"
                    >
                      <div
                        style={{
                          padding: "8px 13px",
                      ...
                      {apSuggestions.length > 0 ? (
                        apSuggestions.map((sg) => (
                          <div
                            ...
                            data-testid="ap-suggestion-row"
                          >
                            <span style={{ color: "#16A82A", fontWeight: 700 }}>+</span>
                            {sg}
                          </div>
                        ))
                      ) : (
                        ...
                        <div
                          style={{ padding: "9px 13px", fontSize: 12.5, color: "#9AA59E" }}
                          data-testid="ap-suggestions-empty"
                        >
                          No suggestions yet — they come from your step-1 knowledge.
                        </div>
                      )}
                ...
                >
                  {AP_PARAM_DEFS.map((p) => (
                    <div key={p.key} style={{ position: "relative" }}>
                      <div
                        onClick={() => {
                          setOpenDD((v) => (v === p.key ? null : p.key));
                          setApAddOpen(false);
                        }}
                        style={{
                          border: "1px solid #EBE3D6",
                      ...
                      {openDD === p.key ? (
                        <div
                          ...
                          data-testid={`ap-param-menu-${p.key}`}
                        >
                          {PARAM_OPTS[p.key]!.map((o) => (
                            ...
                            >
                              <span style={{ width: 13, color: "#16A82A", fontSize: 11 }}>
                                {capture.apParams[p.key] === o ? "✓" : ""}
                              </span>
                              {o}
                            </div>
                          ))}
                  ...
                  {SIG_DEFS.map((s) => {
                    ...
                    return (
                      <span
                        key={s.key}
                        onClick={() =>
                          setCapture((c) => ({ ...c, apSignals: { ...c.apSignals, [s.key]: !on } }))
                        }
                        style={{
                          display: "inline-flex",
                          alignItems: "center",
                          ...
                          fontSize: 12.5,
                          fontWeight: 600,
                          color: on ? "#16A82A" : "#9AA59E",
                          background: on ? "rgba(53,232,52,.1)" : "#F2EEE4",
                          border: on ? "1px solid rgba(53,232,52,.3)" : "1px solid #EBE3D6",
                          borderRadius: 100,
                          padding: "6px 12px",
                          cursor: "pointer",
                        }}
                        data-testid={`ap-signal-${s.key}`}
                      >
                        {s.icon} {s.label}{" "}
                        <span style={{ fontSize: 11, opacity: 0.7 }}>{on ? "✓" : "+"}</span>
                      </span>
                    );
                  })}
                </div>
          ...
          {/* inbound capture */}
          <div>
            <div style={{ fontSize: 13, fontWeight: 700, color: "#5C6B62", marginBottom: 3 }}>
              Inbound capture
            </div>
            <div style={{ fontSize: 12.5, color: "#9AA59E", marginBottom: 12 }}>
              Turn on a channel and pick an asset to collect inbound leads.
            </div>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      background: on ? "rgba(53,232,52,.03)" : "#fff",
                      borderRadius: 14,
                      boxShadow: "0 1px 4px rgba(14,21,18,.04)",
                    }}
                    data-testid={`inbound-${d.key}`}
                  >
                    <div
                      onClick={() => setInboundExpanded((v) => (v === d.key ? null : d.key))}
                      style={{
                        display: "flex",
                        alignItems: "center",
                        gap: 12,
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontSize: 14.5, fontWeight: 700, color: "#0E1512" }}>
                          {d.label}
                        </div>
                      ...
                      <span
                        onClick={(e) => {
                          e.stopPropagation();
                          setCapture((c) => ({ ...c, [d.key]: !on }));
                          if (!on) setInboundExpanded(d.key);
                        }}
                        style={{
                          width: 42,
                          height: 24,
                        ...
                        data-testid={`inbound-${d.key}-toggle`}
                      >
                        <span
                          style={{
                            position: "absolute",
                      ...
                      <span style={{ color: "#C2B79F", fontSize: 16, flex: "none" }}>
                        {expanded ? "⌄" : "›"}
                      </span>
                    </div>
                    {expanded ? (
                      <div style={{ padding: "0 16px 16px" }}>
                        <div style={{ position: "relative" }}>
                          <div
                            onClick={() => {
                              setOpenDD((v) => (v === `asset-${d.key}` ? null : `asset-${d.key}`));
                              setApAddOpen(false);
                            }}
                            style={{
                              display: "flex",
                            ...
                            data-testid={`inbound-${d.key}-select`}
                          >
                            Select an asset…
                            <span style={{ marginLeft: "auto", color: "#9AA59E" }}>⌄</span>
                          </div>
                          {openDD === `asset-${d.key}` ? (
                            <div
                              ...
                              data-testid={`inbound-${d.key}-menu`}
                            >
                              {/* honest absence — no Forms/Widget subsystem exists yet (nav stubs only) */}
                              <div
                                style={{ padding: "10px 13px", fontSize: 12.5, color: "#9AA59E" }}
                                data-testid={`inbound-${d.key}-empty`}
                              >
                                {d.emptyLabel} — create one and it appears here.
                              </div>
                              <a
                                href={d.createHref}
                                style={{
                                ...
                                data-testid={`inbound-${d.key}-create`}
                              >
                                {d.createLabel}
                              </a>
                            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {automations.map((a) => (
                <a
                  ...
                  data-testid="suggested-automation-card"
                >
                  <span
                    style={{
                      width: 34,
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: 13.5, fontWeight: 700, color: "#5C6B62" }}>
                      {a.title}
                    </div>
                    <div style={{ fontSize: 12, color: "#9AA59E" }}>{a.desc}</div>
                  </div>
                  <span style={{ fontSize: 12.5, fontWeight: 600, color: "#16A82A", flex: "none" }}>
                    {a.cta}
                  </span>
                </a>
              ))}
          ...
          <div style={{ fontSize: 13, color: "#9AA59E" }}>
            This step is optional — you can skip it and add lead capture later.
          </div>
        </div>
      </div>
      ...
      <div
        style={{ display: "flex", flexDirection: "column", gap: 16, ...dim }}
        data-testid="capture-preview-col"
      >
        {apOn ? (
          <div
            style={{ background: "#0C140F", borderRadius: 18, padding: 22 }}
            data-testid="ap-preview-panel"
          >
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}>
              <span
                style={{
                  ...
                  borderRadius: "50%",
                  background: "#35E834",
                  boxShadow: "0 0 0 4px rgba(53,232,52,.2)",
                  flex: "none",
                }}
              />
              ...
              {SIG_DEFS.filter((s) => capture.apSignals[s.key]).map((s) => (
                <span
                  ...
                  style={{
                    ...
                    color: "#CFF8D6",
                    background: "rgba(53,232,52,.12)",
                    border: "1px solid rgba(53,232,52,.25)",
                    borderRadius: 100,
                    padding: "5px 10px",
                  }}
                  data-testid="ap-live-signal"
                >
                  {s.icon} {s.label}
                </span>
              ))}
            ...
            <div style={{ background: "#fff", borderRadius: 14, overflow: "hidden" }}>
              ...
              <div style={{ padding: "16px 14px" }} data-testid="ap-preview-empty">
                <div style={{ fontSize: 13.5, fontWeight: 700, color: "#0E1512", marginBottom: 3 }}>
                  Matches appear after launch
                </div>
                <div style={{ fontSize: 12, color: "#5C6B62", lineHeight: 1.5 }}>
                  Your agent starts prospecting from these signals the moment it goes live — matched
                  leads land in this campaign automatically.
                </div>
              </div>
            </div>
          </div>
          ...
          <div
            ...
            data-testid="capture-preview-empty"
          >
            <div style={{ fontSize: 30, marginBottom: 10, opacity: 0.5 }}>👁</div>
            <div style={{ fontSize: 14, fontWeight: 700, color: "#5C6B62", marginBottom: 3 }}>
              Nothing to preview yet
            </div>
            <div style={{ fontSize: 12.5, color: "#9AA59E", lineHeight: 1.5 }}>
              Turn on auto-prospecting or pick an inbound asset to see it previewed here.
            </div>
          </div>
        )}
      </div>
