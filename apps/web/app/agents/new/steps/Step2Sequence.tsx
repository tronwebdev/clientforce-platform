...
interface Step2Props {
  ...
  setSubNewPrefill: React.Dispatch<
    React.SetStateAction<{ name: string; trigger: CampaignRuleTrigger } | null>
  >;
...
export function Step2Sequence(props: Step2Props) {
  ...
  const modeMismatch =
    graph !== null && mainSteps(graph).length > 0 && (composeMode === "guided") !== guidedPlanned;
    ...
    <>
          ...
          <>
            ...
            <div
              style={{
                ...
                gap: 0,
                marginBottom: 22,
                borderBottom: "2px solid #EBE3D6",
              }}
            >
              <div
                onClick={() => setSeqView("sequence")}
                style={{
                  display: "flex",
                  alignItems: "center",
                  gap: 7,
                  padding: "10px 18px",
                  fontSize: 14,
                  fontWeight: seqView === "sequence" ? 700 : 500,
                  color: seqView === "sequence" ? "#0E1512" : "#8A7F6B",
                  borderBottom: `2px solid ${seqView === "sequence" ? "#16A82A" : "transparent"}`,
                  marginBottom: -2,
                  cursor: "pointer",
                }}
              ...
              <div
                ...
                style={{
                  ...
                  padding: "10px 18px",
                  fontSize: 14,
                  fontWeight: seqView === "branches" ? 700 : 500,
                  color: seqView === "branches" ? "#0E1512" : "#8A7F6B",
                  borderBottom: `2px solid ${seqView === "branches" ? "#16A82A" : "transparent"}`,
                  marginBottom: -2,
                  cursor: "pointer",
                }}
              ...
              >
                ...
                <span
                  style={{
                    fontSize: 11,
                    fontWeight: 800,
                    color: seqView === "branches" ? "#fff" : "#8A7F6B",
                    background: seqView === "branches" ? "#0E1512" : "#F2EEE4",
                    borderRadius: 100,
                    padding: "2px 8px",
                  }}
                >
            ...
            {seqView === "sequence" ? (
              <div data-testid="sequence">
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
                  ...
                  >
                    🕐 Mon–Fri · {parseInt(windowStart, 10)}–{parseInt(windowEnd, 10)} ·{" "}
                    {tzShort(timezone)} <span style={{ color: "#9AA59E" }}>⌄</span>
                  </span>
                  ...
                  >
                    <span
                      ...
                      style={{
                        ...
                        boxShadow:
                          composeMode === "guided" ? "none" : "0 1px 4px rgba(14,21,18,.1)",
                        borderRadius: 9,
                        padding: "7px 13px",
                        cursor: "pointer",
                        whiteSpace: "nowrap",
                      }}
                      data-testid="seq-mode-scripted"
                    >
                      Scripted
                    </span>
                    <span
                      ...
                      style={{
                        ...
                        boxShadow:
                          composeMode === "guided" ? "0 1px 4px rgba(14,21,18,.1)" : "none",
                        borderRadius: 9,
                        padding: "7px 13px",
                        cursor: "pointer",
                        whiteSpace: "nowrap",
                      }}
                      data-testid="seq-mode-guided"
                    >
                  ...
                  >
                    {modeMismatch ? "✦ Regenerate to apply" : "✦ Regenerate with AI"}
                  </span>
                </div>
                ...
                {composeMode === "guided" ? (
                  <div
                    ...
                    data-testid="seq-guided-banner"
                  >
                    <span style={{ flex: "none", color: "#1192A6" }}>✦</span>
                    <span>
                      Email and SMS steps carry a <b>brief</b> instead of fixed copy — the AI
                      composes a fresh message per lead at send time, inside your rails.
                      {modeMismatch ? (
                        <span data-testid="regen-to-apply-note">
                          {" "}
                          <b>These steps were planned as scripted</b> — hit ✦ Regenerate to apply
                          guided composing.
                        </span>
                      ) : null}
                    </span>
                ...
                {mainPath(graph).map((n) => {
                  if (n.type === "step") {
                    ...
                    const gd = guidedCardDisplay(
                      n,
                      pendingGuided,
                      { index: idx, count: mainSteps(graph).length },
                      { goal, category },
                    );
                    return (
                      <div
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            {gd && gd.kind !== "aidraft" ? (
                              <>
                                ...
                                <span
                                  ...
                                  data-testid="seq-guided-credits"
                                >
                            ...
                            <OutcomeBadge
                              step={outcomes?.steps.find((s) => s.stepNodeId === n.id)}
                            />
                            <span
                              style={{ marginLeft: "auto", fontSize: 13, color: "#9AA59E" }}
                              data-testid="seq-edit"
                            >
                              ✎ Edit
                            </span>
                          </div>
                          {gd?.kind === "brief" ? (
                            <>
                              ...
                              {n.channel === "email" && gd.brief.subjectHint ? (
                                <div
                                  style={{ fontSize: 13, color: "#8A7F6B", marginBottom: 6 }}
                                  data-testid="seq-brief-subject-hint"
                                >
                                  Subject hint:{" "}
                    ...
                    return (
                      ...
                      >
                        ...
                        <span
                          ...
                          data-testid="seq-delay"
                        >
                          ⏱ Wait {n.amount} {n.amount === 1 ? n.unit.replace(/s$/, "") : n.unit}{" "}
                          <span style={{ color: "#C2B79F" }}>✎</span>
                        </span>
                      </div>
                    );
                  }
                      ...
                      return (
                        ...
                        >
                          ...
                          <div
                            onClick={() => {
                              setEditNode(sNode);
                              setEditSubject(sNode.content.subject ?? "");
                              setEditBody(sNode.content.body ?? "");
                            }}
                            style={{
                              flex: 1,
                              background: "#fff",
                          ...
                          >
                            ...
                            >
                              ...
                              <span style={{ marginLeft: "auto", fontSize: 13, color: "#9AA59E" }}>
                                ✎ Edit
                              </span>
                            </div>
                            <div
                ...
                <div style={{ fontSize: 12, color: "#9AA59E", textAlign: "center", marginTop: 14 }}>
                  Graph v{graphVersion} ·{" "}
                  {graphSource === "MANUAL" ? "edited — new version saved (MANUAL)" : "AI-planned"}
                </div>
              </div>
            ) : (
              <div
              ...
              >
                  ...
                  <div style={{ display: "flex", alignItems: "center", marginBottom: 12 }}>
                    ...
                    <div style={{ position: "relative" }}>
                      <span
                        ...
                        data-testid="suggest-branches"
                      >
                        ✦ Suggest more branches
                      </span>
                      {suggestOpen ? (
                        <div
                          style={{
                        ...
                        >
                          ...
                          >
                            Deterministic suggestions from your goal — AI drafts the steps if you
                            want.
                          </div>
                  ...
                  <div style={{ background: "#0C140F", borderRadius: 14, padding: "18px 20px" }}>
                    <div style={{ display: "flex", alignItems: "center", marginBottom: 14 }}>
                      <div style={{ flex: 1 }}>
                        ...
                        >
                          Main sequence · {mainSteps(graph).length} steps
                        </div>
                        <div
                          style={{ fontSize: 11.5, color: "rgba(255,255,255,.4)", marginTop: 2 }}
                        >
                          {audienceTotal
                            ? `${audienceTotal} contact${audienceTotal === 1 ? "" : "s"} enroll at launch`
                            : "Contacts enroll at launch"}{" "}
                          · Draft
                        </div>
                      </div>
                      <span
                    ...
                    >
                      {mainSteps(graph).map((s, i, arr) => (
                        <Fragment key={s.id}>
                          ...
                          >
                            {s.type === "step" && s.channel === "sms"
                              ? "💬 SMS"
                              : `✉ ${s.type === "step" ? (s.content.subject ?? "") : ""}`}
                          </div>
                          {i < arr.length - 1 ? (
                            <span
                              style={{ color: "rgba(255,255,255,.25)", fontSize: 11, flex: "none" }}
                            >
                              →
                            </span>
                          ) : null}
                ...
                <div>
                    ...
                    {branchCases.map((c, i) => {
                      ...
                      return (
                        <div
                          ...
                          data-testid="branch-rule"
                        >
                          <span style={{ fontSize: 13, color: "#0E1512", flex: 1 }}>
                            {branchWhenLabel(c.when)}
                          </span>
                          <span
                            style={{
                              fontSize: 12,
                              ...
                              borderRadius: 8,
                              padding: "4px 11px",
                              background: c.when === "default" ? "#F2EEE4" : "#D7F5DD",
                              color: c.when === "default" ? "#8A7F6B" : "#16A82A",
                              flex: "none",
                            }}
                          >
                            → {gotoLabel}
                  ...
                  <div style={{ fontSize: 12, color: "#9AA59E", marginTop: 10 }}>
                    Replies are classified by intent (P1.7) — the branch fires the moment a lead
                    answers.
                  </div>
                </div>
                            ...
                            return (
                              ...
                              >
                                ...
                                <span
                                  ...
                                  data-testid="sub-delay"
                                >
                                  ⏱ Wait {cNode.amount}{" "}
                                  {cNode.amount === 1 ? cNode.unit.replace(/s$/, "") : cNode.unit}{" "}
                                  <span style={{ color: "#C2B79F" }}>✎</span>
                                </span>
                              </div>
                            );
                            ...
                            >
                              ...
                              <div
                                onClick={() => {
                                  setEditNode(sNode);
                                  setPreview(null);
                                  if (sNode.mode === "guided" && sNode.brief) {
                                    setEditBrief({
                                      channel: sNode.channel === "sms" ? "sms" : "email",
                                      objective: sNode.brief.objective,
                                      subjectHint: sNode.brief.subjectHint ?? "",
                                      talkingPoints: [...sNode.brief.talkingPoints],
                                      mustSay: [...(sNode.brief.mustSay ?? [])],
                                      neverSay: [...(sNode.brief.neverSay ?? [])],
                                    });
                                  } else {
                                    setEditBrief(null);
                                    setEditSubject(sNode.content.subject ?? "");
      ...
      {delayEdit ? (
        <Modal onClose={() => setDelayEdit(null)} title="Edit delay" tid="delay-modal">
          ...
          >
            <Stepper
              onMinus={() => setDelayAmount((v) => Math.max(1, v - 1))}
              onPlus={() => setDelayAmount((v) => v + 1)}
              value={`${delayAmount} ${delayEdit.type === "delay" ? delayEdit.unit : "days"}`}
            />
          </div>
