...
export const tableCard: CSSProperties = {
  background: "#fff",
  border: "1px solid #EBE3D6",
  borderRadius: 18,
  boxShadow: "0 4px 16px rgba(14,21,18,.04)",
...
export const theadRow = (grid: string, small?: boolean): CSSProperties => ({
  display: "grid",
...
export const tbodyRow = (grid: string): CSSProperties => ({
  display: "grid",
  gridTemplateColumns: grid,
  padding: "13px 22px",
  ...
  return (
    <div data-testid={testid}>
      {Array.from({ length: rows }, (_, i) => (
        ...
        >
          <span
            style={{ width: 30, height: 30, borderRadius: 8, background: "#F2EEE4", flex: "none" }}
          />
          <div style={{ flex: 1 }}>
            <div
              style={{
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span
            style={{ fontFamily: BRICO, fontWeight: 700, fontSize: 17, color: "#0E1512", flex: 1 }}
          >
            {title}
          </span>
          <span
...
export function DrawerShell({
  ...
  return (
    <div
      onClick={onClose}
      style={{ position: "fixed", inset: 0, background: "rgba(12,20,15,.45)", zIndex: z }}
    >
      <div
        onClick={(e) => e.stopPropagation()}
        style={{
...
const DNS: FlowStep = {
  ...
  records: [
    { type: "TXT", host: "@", value: "v=spf1 include:cf-mail.co ~all" },
    { type: "CNAME", host: "cf._domainkey", value: "cf._domainkey.cf-mail.co" },
    ...
    providers: [
      {
        id: "gmail",
        glyph: "G",
        tbg: "rgba(208,245,107,.45)",
        tfg: "#6B7A1F",
        name: "Google / Gmail",
        desc: "Gmail or Workspace via OAuth",
      },
      {
        id: "outlook",
        glyph: "O",
        tbg: "rgba(54,215,237,.16)",
        tfg: "#1192A6",
        name: "Microsoft 365 / Outlook",
        desc: "Outlook.com or Microsoft 365",
      },
      {
        id: "exchange",
        glyph: "E",
        ...
        tfg: "#1192A6",
        name: "Exchange",
        desc: "Microsoft Exchange via OAuth",
      },
      {
        id: "custom",
        glyph: "@",
        ...
        desc: "Any provider with IMAP + SMTP",
      },
      {
        id: "mailer",
        glyph: "cf",
        tbg: "rgba(53,232,52,.16)",
        tfg: "#16A82A",
        name: "Clientforce Mailer",
        desc: "Managed sending, zero setup",
      },
    ],
    steps: {
      gmail: [
        ...
        DNS,
        {
          kind: "summary",
          title: "Connected",
          summary: ["Authorized via Google OAuth", "Open & reply tracking on", "Warm-up enabled"],
        },
      ],
      outlook: [
        {
          kind: "auth",
          title: "Authorize Microsoft",
          authLabel: "Sign in with Microsoft",
          perms: ["Send mail as you", "Read reply metadata"],
        },
        DNS,
        {
          kind: "summary",
          title: "Connected",
          summary: ["Authorized via Microsoft OAuth", "Open & reply tracking on"],
        },
      ],
      exchange: [
        {
      ...
      custom: [
        {
          kind: "fields",
          title: "Sending server (SMTP)",
          verify: true,
          fields: [
            { label: "From email", ph: "you@domain.com" },
            { label: "Sender name", ph: "Jordan at BrightPath" },
            { label: "SMTP host", ph: "smtp.domain.com" },
            { label: "Port", ph: "587" },
            { label: "Encryption", ph: "TLS", sel: true },
            { label: "Username", ph: "you@domain.com" },
            { label: "Password", ph: "app password", pw: true },
          ],
        },
        {
          kind: "fields",
          title: "Receiving server (IMAP)",
          verify: true,
          fields: [
            { label: "IMAP host", ph: "imap.domain.com" },
            { label: "Port", ph: "993" },
            { label: "Username", ph: "you@domain.com" },
            { label: "Password", ph: "app password", pw: true },
          ],
        ...
        DNS,
        {
          ...
          summary: ["SMTP verified", "IMAP verified", "Sending from you@domain.com"],
        },
      ],
      mailer: [
        {
          kind: "summary",
          title: "Use Clientforce Mailer",
          cta: "Set up Mailer",
          summary: [
            "No mailbox required",
            "Managed deliverability & warm-up",
            "Add a sending domain to begin",
          ],
        },
      ],
    },
  ...
  phone: {
    ...
    providers: [
      // P2.1 (DEC-061): the LIVE SMS path — creates a real TWILIO_SMS sender.
      {
        ...
        tbg: "rgba(53,232,52,.16)",
        tfg: "#16A82A",
        name: "Connect a Twilio number",
        desc: "A number + messaging service you already run",
      },
      {
        id: "buy",
        glyph: "#",
        ...
        tfg: "#1192A6",
        name: "Buy a number",
        desc: "Search & provision a new number",
      },
      {
        id: "port",
        glyph: "~",
        tbg: "rgba(232,196,91,.2)",
        tfg: "#A87B16",
        name: "Port an existing number",
        desc: "Bring your current number over",
      },
    ],
    steps: {
      twilio: [
        {
          ...
          fields: [
            { label: "Phone number", ph: "+15125550148" },
            { label: "Label", ph: "Clinic SMS" },
            { label: "Messaging service SID", ph: "MG0123456789abcdef0123456789abcdef" },
          ],
        },
        ...
        {
          kind: "fields",
          title: "Who should calls say they are?",
          cta: "Add SMS sender",
          spoken: true,
          fields: [
            { label: "Spoken name (optional)", ph: "Ava — leave blank for “an AI assistant”" },
          ],
        },
      ],
      buy: [
        {
          ...
          cta: "Search",
          fields: [
            { label: "Country", ph: "United States", sel: true },
            { label: "Area code or prefix", ph: "512" },
            { label: "Capabilities", ph: "Voice & WhatsApp", sel: true },
          ],
        },
        {
          kind: "select",
          title: "Pick a number",
          selects: [
            { label: "Available number", value: "+1 (512) 555-0148" },
            { label: "Capabilities", value: "Voice, SMS & WhatsApp" },
          ],
        },
        {
          kind: "fields",
        ...
        },
        {
          ...
          cta: "Buy number",
          summary: ["+1 (512) 555-0148", "Voice, SMS & WhatsApp", "$1.15 / mo plus usage"],
        },
      ],
      port: [
        {
          ...
          fields: [
            { label: "Phone number", ph: "+1 (512) 555-0100" },
            { label: "Current carrier", ph: "Twilio", sel: true },
            { label: "Account number", ph: "Carrier account #" },
            { label: "Account PIN", ph: "PIN", pw: true },
          ],
        },
        {
          kind: "fields",
          title: "Authorization",
          fields: [
            { label: "Authorized name", ph: "Jordan Mensah" },
            { label: "Letter of authorization", ph: "Upload LOA (PDF)" },
          ],
        },
        {
          kind: "summary",
          title: "Submit request",
          cta: "Submit port request",
          summary: ["Porting takes 7-10 business days", "Number stays active until ported"],
        },
      ],
    },
  },
    ...
    providers: [
      {
        ...
        desc: "Fastest, via Facebook Business",
      },
      {
        id: "twilio",
        glyph: "T",
        tbg: "rgba(208,245,107,.45)",
        tfg: "#6B7A1F",
        name: "Connect via Twilio",
        desc: "Use your Twilio WhatsApp sender",
      },
      {
        id: "manual",
        glyph: "@",
        tbg: "#F2EEE4",
        tfg: "#5C6B62",
        name: "Manual (Cloud API)",
        desc: "Phone number ID & token",
      },
    ],
    steps: {
      meta: [
        {
          ...
          perms: ["Manage your WhatsApp Business account", "Send & receive messages"],
        },
        {
          kind: "select",
          title: "Choose sender",
          selects: [
            { label: "WhatsApp Business account", value: "BrightPath Growth" },
            { label: "Phone number", value: "+1 (512) 555-0100" },
            { label: "Display name", value: "BrightPath Growth" },
          ],
        },
        {
          kind: "summary",
          ...
          cta: "Finish",
          summary: ["Meta reviews display name (~1 day)", "Messaging enabled once approved"],
        },
      ],
      twilio: [
        {
          ...
          verify: true,
          fields: [
            { label: "Account SID", ph: "AC0000000000000000" },
            { label: "Auth token", ph: "your auth token", pw: true },
            { label: "WhatsApp number", ph: "+1 (512) 555-0100" },
          ],
        },
        {
          kind: "summary",
          title: "Connected",
          cta: "Finish",
          summary: ["Sending via Twilio", "Inbound replies enabled"],
        },
      ],
      manual: [
        {
          kind: "fields",
          title: "Cloud API details",
          fields: [
            { label: "Phone number ID", ph: "106600000000000" },
            { label: "WABA ID", ph: "209900000000000" },
            { label: "System user token", ph: "EAAG...", pw: true },
          ],
        },
        {
          kind: "summary",
          title: "Connected",
          cta: "Finish",
          summary: ["Cloud API connected", "Webhook verified"],
        },
      ],
    },
  },
      ...
      sender: [
        {
          ...
          cta: "Continue",
          fields: [
            { label: "From address", ph: "you@mail.brightpathgrowth.co" },
            { label: "Display name", ph: "You at BrightPath" },
          ],
        },
        {
          kind: "dns",
        ...
        },
        {
          ...
          summary: [
            ...
            "Managed warm-up active",
            "Sender available to agents",
          ],
        },
      ],
    },
 ...
 */
export function ConnectFlowDrawer({
  channel,
  onClose,
  toast,
  onMailerCreated,
}: {
  channel: "email" | "phone" | "whatsapp" | "mailer";
  onClose: () => void;
  toast: (m: string) => void;
  onMailerCreated?: () => void | Promise<void>;
}) {
  ...
  const smsValid =
    /^\+[1-9]\d{6,14}$/.test(smsPhone.trim()) &&
    smsLabel.trim().length > 0 &&
    /^MG[a-zA-Z0-9]{32}$/.test(smsSid.trim());
  const mailerGateClosed =
    (isMailerLive && cur?.kind === "fields" && !emailValid) ||
    (isSmsLive && cur?.kind === "fields" && !smsValid);
    ...
    if (isSmsLive) {
      ...
      cf("senders", {
        ...
        body: JSON.stringify({
          type: "TWILIO_SMS",
          phone: smsPhone.trim(),
          fromName: smsLabel.trim(),
          messagingServiceSid: smsSid.trim(),
        }),
      })
        .then(async () => {
          if (voiceName.trim()) {
            await cf("voice/defaults", {
              method: "PATCH",
              body: JSON.stringify({ spokenName: voiceName.trim() }),
            }).catch(() =>
              toast(
                "Number added, but the spoken name was rejected — use a plain first name (no titles).",
              ),
            );
          }
          await onMailerCreated?.();
        ...
        .catch(() =>
          toast("Couldn’t add the SMS sender — check the number and messaging service SID."),
        )
        .finally(() => setBusy(false));
      return;
    }
  ...
  const primaryLabel =
    cur?.kind !== undefined && "cta" in (cur ?? {}) && (cur as { cta?: string }).cta
      ? (cur as { cta?: string }).cta!
      : last
        ? "Finish"
        : "Continue";

  const fieldPill: CSSProperties = {
    display: "flex",
    alignItems: "center",
    borderRadius: 11,
    background: "#fff",
          ...
          >
            ...
            <span
              ...
              style={{
                ...
                fontSize: 14,
                fontWeight: 700,
                color: mailerGateClosed ? "#9AA59E" : "#0A0F0C",
                background: mailerGateClosed ? "#ECE7DC" : GRAD,
                borderRadius: 11,
                padding: "10px 20px",
                cursor: mailerGateClosed ? "not-allowed" : "pointer",
                boxShadow: mailerGateClosed ? "none" : "0 6px 16px rgba(53,232,52,.26)",
              }}
      ...
      <div style={{ flex: 1, overflow: "auto", minHeight: 0, padding: "20px 22px" }}>
        {!prov ? (
          <div data-testid="connect-chooser">
            <div style={{ fontSize: 13, color: "#8A7F6B", marginBottom: 14 }}>
              {def.chooserTitle ?? "Choose an option"}
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {(def.providers ?? []).map((p) => (
                <div
                  ...
                  data-testid={`connect-provider-${p.id}`}
                >
                  <span
                    style={{
                      width: 42,
          ...
          <div data-testid="connect-step">
                ...
                >
                  <span
                    style={{
                      ...
                      height: 24,
                      borderRadius: 7,
                      background: provObj?.tbg ?? "rgba(53,232,52,.16)",
                      color: provObj?.tfg ?? "#16A82A",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      fontFamily: BRICO,
                  ...
                  >
                    {providerLogo(prov ?? "", 16, provObj?.glyph ?? "cf")}
                  </span>
                  {cur.authLabel}
                </div>
                {cur.perms.length > 0 ? (
            ...
            {cur.kind === "fields" ? (
              cur.spoken && isSmsLive ? (
                <>
                  ...
                  <div style={{ marginBottom: 13 }}>
                    ...
                    <input
                      ...
                      placeholder="Ava — leave blank for “an AI assistant”"
                      style={{ ...inp, height: 44 }}
                      data-testid="voice-spoken-name"
                    />
                  </div>
                  <div style={{ fontSize: 12, color: "#8A7F6B", lineHeight: 1.5 }}>
                    AI calls open with “Hi, this is{" "}
                    {voiceName.trim() ? voiceName.trim() + ", an AI assistant" : "an AI assistant"}{" "}
                    calling on behalf of…”. A plain first name only — agents can override it in
                ...
                <>
                  ...
                  <div style={{ fontSize: 12, color: "#8A7F6B", lineHeight: 1.5 }}>
                    Advanced Opt-Out must be ON for this messaging service — STOP replies also
                    suppress here automatically (double rail).
                  </div>
                </>
              ) : isMailerLive ? (
                <>
                  ...
                  <div style={{ marginBottom: 13 }}>
                    ...
                    <input
                      ...
                      placeholder="you@mail.brightpathgrowth.co"
                      style={{ ...inp, height: 44 }}
                      data-testid="mailer-from-email"
                    />
                  </div>
                  <div style={{ marginBottom: 13 }}>
                    ...
                    <input
                      ...
                      placeholder="You at BrightPath"
                      style={{ ...inp, height: 44 }}
                      data-testid="mailer-from-name"
                    />
                  </div>
                </>
              ) : (
                <>
                  ...
                  {cur.verify ? (
                    verified ? (
                      verifiedBanner("Connection verified")
                    ) : (
                      <div onClick={() => setVerified(true)} style={{ ...verifyBtn, marginTop: 4 }}>
                        Verify settings
                      </div>
                    )
                  ) : null}
            ...
            {cur.kind === "dns" ? (
              <>
                <div style={{ fontSize: 13, color: "#8A7F6B", marginBottom: 12 }}>
                ...
                >
                  <div
                    style={{
                      display: "grid",
                      gridTemplateColumns: ".7fr 1fr 1.6fr",
                      padding: "9px 14px",
                      background: "#FBF7F0",
                      borderBottom: "1px solid #EBE3D6",
                      fontSize: 11,
                ...
                {verified ? (
                  verifiedBanner("DNS verified — SPF, DKIM & DMARC OK")
                ) : (
                  <div onClick={() => setVerified(true)} style={verifyBtn}>
                    Verify DNS records
                  </div>
                )}
              </>
