  ...
  return (
    <span
      ...
      style={{
        ...
        height: h,
        borderRadius: 100,
        background: on ? "linear-gradient(135deg,#36D7ED,#35E834)" : "#E4EAE6",
        position: "relative",
  ...
  return (
    <div data-testid="section-profile">
            ...
            <div key={w.label}>
              ...
              <div
                style={{
                  ...
                  fontWeight: 600,
                  color: "#0E1512",
                  fontFamily: w.mono ? "monospace" : "inherit",
      ...
      <div style={sectionCard}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 18 }}>
          <div
            style={{
              ...
              height: 60,
              borderRadius: "50%",
              background: "linear-gradient(135deg,#36D7ED,#35E834)",
              color: "#0A0F0C",
              display: "flex",
              alignItems: "center",
          ...
          <span
            onClick={() => toast("Choose a photo to upload")}
            style={{
              fontSize: 13.5,
              fontWeight: 600,
              color: "#0E1512",
        ...
        <div style={{ display: "flex", gap: 16, marginBottom: 14 }}>
          <div style={{ flex: 1 }}>
            ...
            <div style={fieldBox}>Jordan Mensah</div>
          </div>
          <div style={{ flex: 1 }}>
            <label style={lbl}>Email</label>
            <div style={fieldBox}>jordan@brightpathgrowth.co</div>
          </div>
        </div>
        <div style={{ display: "flex", gap: 16 }}>
          <div style={{ flex: 1 }}>
            <label style={lbl}>Company</label>
            <div style={fieldBox}>BrightPath Growth</div>
          </div>
          <div style={{ flex: 1 }}>
      ...
      <div style={{ ...sectionCard, padding: 0, overflow: "hidden" }}>
        ...
        >
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 14, fontWeight: 600, color: "#0E1512" }}>
...
export function BillingSection({ toast }: { toast: (m: string) => void }) {
  ...
  const [topup, setTopup] = useState<{
    ...
    method: string;
    paidCredits: number;
  }>({ open: false, step: 0, packId: "p2", method: "visa", paidCredits: 0 });
  ...
  return (
    <div data-testid="section-billing">
      <div style={{ display: "grid", gridTemplateColumns: "1.3fr 1fr", gap: 16, marginBottom: 16 }}>
        ...
        >
          ...
          <div style={{ fontSize: 13, color: "rgba(255,255,255,.6)", marginBottom: 16 }}>
            ≈ {Math.round(credits / 150)} days at current pace
          </div>
          <span
            onClick={() =>
              setTopup({ open: true, step: 0, packId: "p2", method: "visa", paidCredits: 0 })
            }
            style={{
              display: "inline-block",
              fontSize: 13.5,
          ...
          >
            <div
              style={{
                ...
                width: "23%",
                borderRadius: 100,
                background: "linear-gradient(90deg,#36D7ED,#35E834)",
              }}
            />
          </div>
          <div
      ...
      <div style={{ ...sectionCard, padding: 22, display: "flex", alignItems: "center", gap: 16 }}>
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 13.5, color: "#5C6B62" }}>
            $199 / mo · 8,000 credits · unlimited agents · all channels
          </div>
        </div>
        <span
          onClick={() => toast("Opening plan options…")}
          style={{
            fontSize: 13.5,
            fontWeight: 600,
            color: "#0E1512",
      ...
      <div style={{ ...tableCard, marginBottom: 16 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 13, padding: "18px 22px" }}>
          ...
          <span style={{ fontSize: 14, fontWeight: 600, color: "#0E1512", flex: 1 }}>
            Visa ···· 4242{" "}
            <span style={{ color: "#9AA59E", fontWeight: 400 }}>· expires 08/27</span>
          </span>
          <span
            onClick={() => toast("Update payment method")}
            style={{ fontSize: 13.5, fontWeight: 600, color: "#16A82A", cursor: "pointer" }}
          >
            Update
          </span>
        </div>
      ...
      {topup.open ? (
        <div
          onClick={() => {
            setTopup((t) => ({ ...t, open: false }));
            if (topup.step === 1) toast("Credits added to your balance");
          }}
          style={{
            position: "fixed",
            inset: 0,
            ...
            {topup.step === 0 ? (
              <>
                ...
                >
                  ...
                  <span
                    onClick={() => setTopup((t) => ({ ...t, open: false }))}
                    style={{
                      width: 30,
                      height: 30,
                      borderRadius: 9,
                ...
                <div style={{ padding: "20px 22px" }}>
                  ...
                  >
                    {PACKS.map((p) => {
                      ...
                      return (
                        <div
                          key={p.id}
                          onClick={() => setTopup((t) => ({ ...t, packId: p.id }))}
                          style={{
                            position: "relative",
                            border: on ? "2px solid #35E834" : "1px solid #EBE3D6",
                            background: on ? "rgba(53,232,52,.06)" : "#fff",
                            borderRadius: 13,
                            padding: 14,
                            cursor: "pointer",
                            boxSizing: "border-box",
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    {[
                      { id: "visa", label: "Visa ···· 4242", glyph: "VISA" },
                      { id: "new", label: "Add a new card", glyph: "＋" },
                    ].map((m) => {
                      const on = topup.method === m.id;
                      return (
                        <div
                          key={m.id}
                          onClick={() => setTopup((t) => ({ ...t, method: m.id }))}
                          style={{
                            display: "flex",
                            alignItems: "center",
                            gap: 12,
                        ...
                        >
                          ...
                          <span
                            style={{ fontSize: 14, fontWeight: 600, color: "#0E1512", flex: 1 }}
                          >
                            {m.label}
                          </span>
                          <span
                ...
                >
                  <div style={{ flex: 1 }}>
                    ...
                    <div
                      style={{ fontFamily: BRICO, fontWeight: 800, fontSize: 20, color: "#0E1512" }}
                    >
                      {pack.price}
                    </div>
                  </div>
                  <span
                    onClick={() => {
                      ...
                      setTopup((t) => ({ ...t, step: 1, paidCredits: pack.credits }));
                    }}
                    style={{
                      fontSize: 14,
                      fontWeight: 700,
              ...
              <>
                <div style={{ padding: "32px 26px 22px", textAlign: "center" }}>
                  ...
                  >
                    Added{" "}
                    <strong style={{ color: "#0E1512" }}>
                      {topup.paidCredits.toLocaleString()} credits
                    </strong>
                    . Your new balance is{" "}
                    <strong style={{ color: "#16A82A" }}>{credits.toLocaleString()}</strong>.
                  </div>
                  <div
                    style={{
                      background: "#FBF7F0",
    ...
    <div data-testid="section-custom">
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
        ...
        <span
          ...
          style={{ ...gradBtn, marginLeft: "auto", padding: "11px 18px" }}
      ...
      <div style={tableCard}>
        ...
        {rows.map((f) => (
          <div key={f.slug} style={{ ...tbodyRow(CF_GRID), fontSize: 14, color: "#0E1512" }}>
            ...
            <span style={{ fontFamily: "monospace", fontSize: 12.5, color: "#8A7F6B" }}>
              {f.slug}
            </span>
            <span
              onClick={() => {
                setCfList((arr) => arr.filter((x) => x.slug !== f.slug));
                toast("Custom field removed");
              }}
              style={{ textAlign: "center", color: "#C9543F", fontWeight: 700, cursor: "pointer" }}
              title="Remove"
            >
              ✕
            </span>
        ...
        {rows.length === 0 ? (
          <div style={{ padding: 34, textAlign: "center", color: "#9AA59E", fontSize: 13.5 }}>
                ...
                onClick={() => {
                  ...
                  setCfList((arr) => [
                    ...arr,
                    {
                      label: label.trim(),
                      type,
                      slug: arr.some((x) => x.slug === slug) ? `${slug}_${arr.length}` : slug,
                    },
                  ]);
                  setAddOpen(false);
        ...
        >
          <div style={{ padding: "20px 22px" }}>
            ...
            <input
              ...
              placeholder="e.g. Clinic size"
              style={{ ...inp, marginBottom: 5 }}
            />
            <div style={{ fontSize: 12, color: "#9AA59E", marginBottom: 16 }}>
              Field ID:{" "}
              <span style={{ fontFamily: "monospace", color: "#8A7F6B" }}>{slugify(label)}</span>
            </div>
...
const TEAM_SEED: Member[] = [
  {
    name: "Jordan Mensah",
    email: "jordan@brightpathgrowth.co",
    role: "Owner",
    initials: "JM",
    avbg: "linear-gradient(135deg,#36D7ED,#35E834)",
    status: "Active",
    sbg: "#D7F5DD",
    sfg: "#0F7A28",
  },
  {
    name: "Maya Patel",
    email: "maya@brightpathgrowth.co",
    role: "Admin",
    initials: "MP",
    avbg: "rgba(54,215,237,.4)",
    status: "Active",
    sbg: "#D7F5DD",
    sfg: "#0F7A28",
  },
  {
    name: "Leo Nguyen",
    email: "leo@brightpathgrowth.co",
    role: "Member",
    initials: "LN",
    avbg: "rgba(208,245,107,.6)",
    status: "Active",
    sbg: "#D7F5DD",
    sfg: "#0F7A28",
  },
  {
    name: "Sara Kim",
    email: "sara@brightpathgrowth.co",
    role: "Member",
    initials: "SK",
    avbg: "#F2EEE4",
    status: "Invited",
    sbg: "rgba(232,196,91,.18)",
    sfg: "#A87B16",
  },
];
const ROLES = [
  ...
  return (
    <div data-testid="section-team">
      <div style={tableCard}>
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 13, color: "#9AA59E" }}>
              {team.length} members · 2 seats available
            </div>
          </div>
          <span
            onClick={() => setInvite({ open: true, step: 0, email: "", role: "Member" })}
            style={gradBtn}
        ...
        <div style={{ ...theadRow(TEAM_GRID), borderTop: "1px solid #EBE3D6" }}>
          <span>Member</span>
          <span>Role</span>
          <span>Status</span>
          <span />
          ...
          <div key={m.email} style={tbodyRow(TEAM_GRID)}>
            <span style={{ display: "flex", alignItems: "center", gap: 11, minWidth: 0 }}>
              ...
              <span style={{ minWidth: 0 }}>
                <span style={{ display: "block", fontSize: 14, fontWeight: 600, color: "#0E1512" }}>
                  {m.name}
                </span>
                <span style={{ display: "block", fontSize: 12.5, color: "#9AA59E" }}>
                  {m.email}
                </span>
              </span>
            </span>
      ...
      {invite.open ? (
        <div
          onClick={() => setInvite((v) => ({ ...v, open: false }))}
          style={{
            position: "fixed",
            inset: 0,
            background: "rgba(12,20,15,.45)",
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    {ROLES.map((r) => {
                      ...
                      return (
                        <div
                          key={r.id}
                          onClick={() => setInvite((v) => ({ ...v, role: r.id }))}
                          style={{
                            display: "flex",
                            alignItems: "center",
                            gap: 12,
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      fontSize: 14,
                      fontWeight: 700,
                      color: emailValid ? "#0A0F0C" : "#9AA59E",
                      background: emailValid ? GRAD : "#ECE7DC",
                      borderRadius: 11,
                      padding: "10px 20px",
              ...
              <>
                <div style={{ padding: "30px 26px 22px", textAlign: "center" }}>
                  ...
                  >
                    ...
                    <strong style={{ color: "#0E1512" }}>{sent.email}</strong> with{" "}
                    <strong style={{ color: "#0E1512" }}>{sent.role}</strong> access. They’ll appear
                    as “Invited” until they accept.
                  </div>
                ...
                >
                  <span
                    onClick={() => setInvite({ open: true, step: 0, email: "", role: "Member" })}
                    style={{ fontSize: 14, fontWeight: 600, color: "#16A82A", cursor: "pointer" }}
                  >
                    + Invite another
                  </span>
                  <span
  ...
  return (
    <div data-testid="section-schedules">
      ...
      >
        ...
        <span onClick={() => setModalOpen(true)} style={gradBtn}>
          + New schedule
        </span>
      </div>
      <div style={tableCard}>
        <div style={theadRow(SCHEDULE_GRID)}>
          <span>Name</span>
          <span>Days</span>
          <span>Hours</span>
          <span>Timezone</span>
        ...
        {SCHEDULES.map((s) => (
          <div
            key={s.name}
            style={{ ...tbodyRow(SCHEDULE_GRID), fontSize: 13.5, color: "#0E1512" }}
          >
            ...
            <span
              onClick={() => toast("Row actions")}
              style={{ textAlign: "center", color: "#9AA59E", fontWeight: 700, cursor: "pointer" }}
            >
              ⋯
            </span>
          </div>
...
const USAGE = [
  {
    ...
    total: "20,000",
    pct: "23%",
    color: "linear-gradient(90deg,#36D7ED,#35E834)",
  },
  ...
  return (
    <div data-testid="section-usage">
      ...
      >
        ...
        >
          June 2026 <span style={{ color: "#9AA59E" }}>⌄</span>
        </span>
      </div>
        ...
        {USAGE.map((u) => (
          <div key={u.label} style={{ padding: "13px 0", borderTop: "1px solid #F2EEE4" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 7 }}>
              ...
              <span style={{ fontSize: 13, color: "#9AA59E" }}>
                {u.used} / {u.total}
              </span>
            </div>
            <div
              style={{ height: 8, borderRadius: 100, background: "#F2EEE4", overflow: "hidden" }}
            >
              <div
                style={{ height: "100%", width: u.pct, borderRadius: 100, background: u.color }}
              />
            </div>
          </div>
        ))}
...
const PHONES = [
  {
    ...
    label: "Main line",
    badges: [
      { label: "Voice default", fg: "#0F7A28", bg: "#D7F5DD" },
      { label: "WA default", fg: "#0F7A28", bg: "#D7F5DD" },
    ],
  },
  {
    e164: "+1 (512) 555-0144",
    channel: "Voice",
    label: "Overflow",
    badges: [{ label: "Voice", fg: "#5C6B62", bg: "#F2EEE4" }],
  },
  {
    e164: "+44 20 7946 0011",
    channel: "WhatsApp",
    label: "UK sender",
    badges: [{ label: "WA", fg: "#5C6B62", bg: "#F2EEE4" }],
  },
];
    ...
    <div data-testid="section-phone">
      ...
      >
        <div>
          ...
          <div style={{ fontSize: 13, color: "#9AA59E" }}>
            Numbers for AI voice calls &amp; WhatsApp.
          </div>
        </div>
        <span onClick={() => setFlowOpen(true)} style={gradBtn}>
          + Add number
        </span>
      </div>
      <div style={tableCard}>
        <div style={theadRow(PHONE_GRID)}>
          <span>Number</span>
          <span>Channel</span>
          <span>Default</span>
          <span>Name</span>
        ...
        {PHONES.map((p) => (
          <div key={p.e164} style={{ ...tbodyRow(PHONE_GRID), fontSize: 13.5, color: "#0E1512" }}>
            ...
            <span
              onClick={() => toast("Phone number removed")}
              style={{
                textAlign: "center",
                color: "#C9543F",
                fontSize: 12,
      ...
      {flowOpen ? (
        <ConnectFlowDrawer channel="phone" onClose={() => setFlowOpen(false)} toast={toast} />
      ) : null}
    </div>
  );
}
    ...
    <div data-testid="section-whatsapp">
      ...
      >
        <div>
          ...
          <div style={{ fontSize: 13, color: "#9AA59E" }}>
            Business numbers approved for WhatsApp.
          </div>
        </div>
        <span onClick={() => setFlowOpen(true)} style={gradBtn}>
          + Add sender
      ...
      <div
        style={{
          ...
          alignItems: "center",
          gap: 10,
          background: "rgba(232,196,91,.12)",
          border: "1px solid rgba(232,196,91,.45)",
          borderRadius: 12,
          padding: "11px 16px",
          marginBottom: 14,
          boxSizing: "border-box",
        }}
        data-testid="whatsapp-notice"
      >
        <span>ℹ</span>
        <span style={{ fontSize: 12.5, color: "#5C6B62" }}>
          WhatsApp sender setup is being updated — new connections are paused. Existing senders keep
          working.
        </span>
      </div>
      <div style={tableCard}>
        <div style={theadRow(WA_GRID)}>
          <span>Number</span>
      ...
      {flowOpen ? (
        <ConnectFlowDrawer channel="whatsapp" onClose={() => setFlowOpen(false)} toast={toast} />
      ) : null}
    </div>
  );
}
