...
function authPasses(s: Sender): number {
  const auth = (s.domainAuthStatus ?? {}) as Record<
    string,
    { pass?: boolean } | boolean | undefined
  >;
...
export function SettingsTab({
  ...
  const refresh = useCallback(async () => {
    ...
    const vd = (await cf("voice/defaults").catch(() => null)) as {
    ...
    >
      ...
      <div style={card} data-testid="settings-senders">
        <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "16px 18px" }}>
          ...
          >
            Email senders{" "}
            <span style={{ fontSize: 13, fontWeight: 600, color: "#9AA59E" }}>
              · {senders?.length ?? 0} connected
            </span>
          </span>
          <span
            title="Senders are provisioned per workspace (P1.5)"
            style={{
              fontSize: 13,
              fontWeight: 700,
              color: "#16A82A",
        ...
        {senders === null ? (
          <div
            style={{ borderTop: "1px solid #F2EEE4", padding: "14px 18px" }}
            data-testid="senders-skeleton"
          >
          ...
          senders.map((s) => {
            ...
            return (
              <div
                ...
                data-testid="settings-sender-row"
              >
                <span
                  style={{
                    width: 36,
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 14, fontWeight: 700, color: "#0E1512" }}>
                    {s.fromEmail}
                  </div>
                  <div style={{ fontSize: 12, color: "#9AA59E" }}>
                    Clientforce Mailer · {s.sentToday} / {s.dailyLimit} sent today
                  </div>
                </div>
                ...
                <span
                  style={{
                    fontSize: 11,
                    fontWeight: 700,
                    color: active ? "#0F7A28" : "#9A6B12",
                    background: active ? "#D7F5DD" : "#FBEFD2",
                    borderRadius: 7,
                    padding: "5px 10px",
                    flex: "none",
                  }}
      ...
      {(() => {
        ...
        const confirmedName = voiceRider.spokenNameConfirmed
          ? (voiceRider.spokenName ?? null)
          : null;
          ...
          <div style={card} data-testid="settings-voice">
            <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "16px 18px" }}>
              ...
              >
                Voice{" "}
                <span style={{ fontSize: 13, fontWeight: 600, color: "#9AA59E" }}>
                  · how AI calls sound &amp; introduce themselves
                </span>
              </span>
            </div>
            <div style={{ borderTop: "1px solid #F2EEE4", padding: "15px 18px" }}>
              ...
              >
                <span
                  style={{
                    ...
                    borderRadius: 8,
                    flex: "none",
                    background: "linear-gradient(135deg,#36D7ED,#35E834 55%,#D0F56B)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    fontSize: 14,
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div
                    style={{ fontSize: 13.5, fontWeight: 600, color: "#0E1512" }}
                    data-testid="voice-persona-value"
                  >
                    {persona.label} — {persona.descriptor}
                  </div>
                </div>
                <span
                  ...
                  data-testid="voice-persona-change"
                >
                  Change ▾
                </span>
                {personaMenuOpen ? (
                  <div
                    style={{
                      ...
                      border: "1px solid #EBE3D6",
                      borderRadius: 12,
                      boxShadow: "0 10px 28px rgba(14,21,18,.14)",
                      padding: 6,
                      minWidth: 240,
                    }}
                    data-testid="voice-persona-menu"
                  >
                    {VOICE_PERSONAS.map((p) => (
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: 9,
                          cursor: "pointer",
                          background: p.id === persona.id ? "rgba(53,232,52,.08)" : "transparent",
                        }}
                        data-testid={`voice-persona-${p.id}`}
                      >
                        <span
                          style={{ fontSize: 13.5, fontWeight: 600, color: "#0E1512", flex: 1 }}
                        >
                          {p.label} — {p.descriptor}
                        </span>
                        {p.id === persona.id ? (
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <input
                  ...
                  onChange={(e) => {
                    setVoiceNameInput(e.target.value);
                    setVoiceNameError(false);
                  }}
                  onBlur={(e) => {
                    if (e.target.value.trim() && e.target.value.trim() !== confirmedName)
                  ...
                  style={{
                    ...
                    height: 42,
                    borderRadius: 11,
                    border: `1px solid ${voiceNameError ? "#C9543F" : "#EBE3D6"}`,
                    padding: "0 14px",
                    fontSize: 14,
                    color: "#0E1512",
                ...
                {confirmedName ? (
                  <span
                    ...
                    data-testid="voice-name-confirmed"
                  >
                    Confirmed
                  </span>
                ) : inherited ? (
                  <span
                    ...
                    data-testid="voice-name-inherited"
                  >
                    Inherited from workspace
                  </span>
                ) : (
                  <span
                    onClick={() => confirmName(persona.label)}
                    style={{
                      fontSize: 11.5,
                      fontWeight: 700,
                      color: "#1192A6",
                    ...
                    data-testid="voice-name-suggested"
                  >
                    ✦ Use “{persona.label}”
                  </span>
                )}
              ...
              <div
                style={{
                  fontSize: 12,
                  color: voiceNameError ? "#C9543F" : "#8A7F6B",
                  lineHeight: 1.5,
                  marginTop: 7,
                }}
                data-testid="voice-name-note"
              >
                {voiceNameError
      ...
      <div style={{ ...card, padding: "18px 20px" }} data-testid="settings-schedule">
        ...
        <div style={{ fontSize: 12.5, color: "#9AA59E", marginTop: 2, marginBottom: 16 }}>
          The agent only sends inside this window — replies are handled 24/7.
        </div>
        <div style={{ display: "flex", gap: 16, marginBottom: 16 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              {g ? `${g.sendingWindow.start} – ${g.sendingWindow.end}` : "09:00 – 17:00"}
              <span style={{ color: "#9AA59E", fontSize: 11 }}>▾</span>
            </div>
          </div>
        </div>
          ...
          {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((d, i) => {
            ...
            return (
              <span
                key={d}
                onClick={() => {
                  const next = days.map((v, j) => (j === i ? !v : v));
                  setDays(next);
                  void saveGuardrails({ days: next });
                }}
                style={{
                  flex: 1,
                  textAlign: "center",
                  ...
                  padding: "9px 0",
                  borderRadius: 10,
                  background: on ? GRAD : "#FBF7F0",
                  color: on ? "#0A0F0C" : "#9AA59E",
                  border: `1px solid ${on ? "transparent" : "#EBE3D6"}`,
                  cursor: "pointer",
                }}
                data-testid={`settings-day-${d}`}
              >
                {d}
              </span>
            );
      ...
      <div style={{ ...card, padding: "18px 20px" }} data-testid="settings-volume">
        <div style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 16 }}>
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              Volume &amp; deliverability limits
            </div>
            <div style={{ fontSize: 12.5, color: "#9AA59E", marginTop: 2 }}>
              Daily caps protect your sender reputation across channels.
            </div>
          </div>
          <span
            onClick={() => setVolumeOpen(true)}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 10 }}>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
              ...
              <span style={{ fontSize: 13, fontWeight: 600, color: "#0E1512", flex: 1 }}>
                Email / day
              </span>
              <span
                style={{
              ...
              >
                {view?.sentToday ?? 0} / {dailyCap}
              </span>
            </div>
            <div
              style={{ height: 6, borderRadius: 100, background: "#EBE3D6", overflow: "hidden" }}
            >
              <div
                style={{
                  height: "100%",
                  width: `${Math.min(100, Math.round(((view?.sentToday ?? 0) / Math.max(1, dailyCap)) * 100))}%`,
                  background: "#35E834",
                }}
              />
            </div>
        ...
        {[
          {
            key: "open" as const,
            label: "Open tracking",
            desc: "Track when a prospect opens an email.",
          },
          {
            key: "link" as const,
            label: "Link tracking",
            desc: "Track clicks on links in your emails.",
          },
        ].map((t) => (
          <div
            key={t.key}
          ...
          >
            ...
            <span
              onClick={() => {
                const nextT = { ...tracking, [t.key]: !tracking[t.key] };
                setTracking(nextT);
                void saveGuardrails({ tracking: nextT });
              }}
              style={{
                width: 44,
                height: 26,
                borderRadius: 100,
                background: tracking[t.key] ? GRAD : "#D8CFBE",
                position: "relative",
      ...
      <div
        style={{ ...card, padding: "18px 20px", overflow: "visible" }}
      ...
      >
        ...
        <div style={{ fontSize: 12.5, color: "#9AA59E", marginTop: 2, marginBottom: 14 }}>
          What this agent writes in — sequences, reply drafts, and the compliance lines below. Your
        ...
        <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
          <div style={{ flex: 1, position: "relative" }}>
            <div
              ...
              style={{
                ...
                borderRadius: 11,
                background: "#FBF7F0",
                border: `1px solid ${langMenuOpen ? "#35E834" : "#EBE3D6"}`,
                display: "flex",
                alignItems: "center",
                justifyContent: "space-between",
                padding: "0 14px",
            ...
            >
              <span style={{ fontWeight: 600 }}>
                ...
                {LANGUAGE_META[language].native !== LANGUAGE_META[language].label ? (
                  <span style={{ color: "#9AA59E", fontWeight: 500 }}>
                    {" "}
            ...
            {langMenuOpen ? (
              <div
                style={{
                  ...
                  border: "1px solid #EBE3D6",
                  borderRadius: 12,
                  boxShadow: "0 14px 40px rgba(14,21,18,.14)",
                  padding: 6,
                  zIndex: 30,
                }}
            ...
            <div
              style={{ fontSize: 12, color: "#9AA59E", marginTop: 6 }}
              data-testid="language-provenance"
            >
          ...
          <div
            ...
            data-testid="language-compliance-preview"
          >
            <div
              style={{
                fontSize: 11,
            ...
            >
              Compliance lines — always on, in this language
            </div>
            <div style={{ display: "flex", gap: 8, alignItems: "baseline", marginBottom: 6 }}>
              ...
              >
                {COMPLIANCE_STRINGS[language].unsubscribeLabel}: reply.clientforce.io/u/…
              </span>
            </div>
            <div style={{ display: "flex", gap: 8, alignItems: "baseline" }}>
              ...
              >
                {COMPLIANCE_STRINGS[language].smsOptOut}
              </span>
            </div>
            <div style={{ fontSize: 11.5, color: "#8A7F6B", marginTop: 8 }}>
              Rendered after your company address on every email · on the first SMS of each
              conversation. Pre-translated — never AI-written.
            </div>
          </div>
        </div>
        <div
          style={{
            ...
            fontSize: 12.5,
            color: "#8A7F6B",
            background: "rgba(53,232,52,.07)",
            borderRadius: 10,
            padding: "10px 13px",
            marginTop: 14,
          }}
          data-testid="language-footnote"
        >
          <span style={{ fontSize: 13 }}>ⓘ</span>
          <span>
            Applies to future regenerations and sends — steps already planned keep their language
            until you regenerate the sequence; messages already sent are unchanged. The compliance
            lines switch at send time.
          </span>
        </div>
      </div>
      ...
      <div style={{ ...card, padding: "18px 20px" }} data-testid="settings-compose-mode">
        ...
        >
          How this agent writes messages
        </div>
        <div style={{ fontSize: 12.5, color: "#9AA59E", marginTop: 2, marginBottom: 14 }}>
          Applies to email and SMS sequence steps; replies to leads stay scripted this phase.
        </div>
        <div style={{ display: "flex", gap: 10 }}>
          {[
            {
              key: "scripted" as const,
              title: "Scripted",
              desc: "Sends each step's exact saved copy — what you see is what every lead gets.",
            },
            {
              key: "guided" as const,
              title: "✦ AI-guided",
              desc: "Steps carry talking points; the AI composes each email or SMS per lead at send time, checked before anything sends. Compliance footers are always added by the platform.",
            },
          ].map((opt) => {
            ...
            return (
              <div
                key={opt.key}
                onClick={() => {
                  if (composeMode !== opt.key) {
                    setComposeMode(opt.key);
                    void saveGuardrails({ composeMode: opt.key });
                  }
                }}
                style={{
                  flex: 1,
                  border: `1.5px solid ${on ? "#35E834" : "#EBE3D6"}`,
                  background: on ? "rgba(53,232,52,.06)" : "#FBF7F0",
                  borderRadius: 13,
                  padding: "13px 15px",
                  cursor: "pointer",
                }}
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
                  <span
                    style={{
                      ...
                      height: 16,
                      borderRadius: "50%",
                      border: `5px solid ${on ? "#16A82A" : "#D8CFBE"}`,
                      background: "#fff",
                      flex: "none",
        ...
        <div
          ...
          data-testid="compose-mode-footnote"
        >
          <span style={{ fontSize: 13 }}>ⓘ</span>
          <span>
            Applies to future sends — sequences you generate from now on plan{" "}
            {composeMode === "guided" ? "guided" : "scripted"} steps. Steps already planned keep
            their mode until you regenerate the sequence; messages already sent are unchanged.{" "}
            {/* W3-4 (DEC-076): the toggle is no longer inert post-launch —
                deep-link to the Steps tab's ✦ Regenerate (closes W3-12). */}
            <a
              href={`/agents/${agentId}/steps`}
              style={{ color: "#16A82A", fontWeight: 700, textDecoration: "none" }}
              data-testid="compose-mode-regen-link"
            >
              Regenerate in the Steps tab ›
            </a>
          </span>
        </div>
      </div>
      ...
      <div style={{ ...card, padding: "18px 20px" }} data-testid="settings-strategy">
        {(() => {
          ...
          return (
            ...
            >
              ...
              <div style={{ fontSize: 13, color: "#5C6B62", marginTop: 4, lineHeight: 1.45 }}>
                {s.arc.description}
              </div>
              <div style={{ fontSize: 12, color: "#9AA59E", marginTop: 8 }}>
                Derived from your goal and business category ({s.category}) at creation.
              </div>
            </div>
          );
        })()}
        ...
        <textarea
          ...
          onBlur={() => {
            if ((view?.guardrails?.strategy?.strategyNotes ?? "") !== notes.trim())
              void saveGuardrails({});
          }}
        ...
        <div style={{ fontSize: 12.5, color: "#9AA59E", marginBottom: 8 }}>
          Words or phrases the AI must never use — generated sequences are checked and repaired
          automatically.
        </div>
        {neverSay.length > 0 ? (
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 10 }}>
            {neverSay.map((term) => (
              <span
                ...
                data-testid="neversay-chip"
              >
                {term}
                <span
                  onClick={() => removeNeverSay(term)}
                  style={{
                    width: 18,
                    height: 18,
                    borderRadius: "50%",
        ...
        {neverSay.length < NEVER_SAY_MAX ? (
          ...
          <div
            ...
            data-testid="neversay-cap"
          >
            {NEVER_SAY_MAX} of {NEVER_SAY_MAX} — remove one to add another.
          </div>
        )}
        ...
        <div
          ...
          data-testid="strategy-footnote"
        >
          <span style={{ fontSize: 13 }}>ⓘ</span>
          <span>
            Changes apply the next time the sequence is generated and to newly enrolled contacts —
            messages already scheduled for contacts in flight aren&apos;t rewritten.
          </span>
        </div>
      </div>
      ...
      >
        ...
        >
          <div style={{ fontSize: 14, color: "#5C6B62" }}>
            Archive pauses sending &amp; hides the agent. Delete is permanent.
          </div>
          <div style={{ display: "flex", gap: 10, flex: "none" }}>
            <span
              onClick={() => {
                void cf(`agents/${agentId}`, {
                  method: "PATCH",
                  body: JSON.stringify({ status: "ARCHIVED" }),
                })
                  .then(() => router.push("/agents"))
                  .catch(() => {});
              }}
              style={{
                fontSize: 13,
            ...
            <span
              onClick={() => {
                if (window.confirm("Delete this agent permanently? This cannot be undone."))
                  void cf(`agents/${agentId}`, { method: "DELETE" })
                    .then(() => router.push("/agents"))
                    .catch(() => {});
              }}
              style={{
      ...
      {drawer ? (
        <div
          ...
          style={{ position: "fixed", inset: 0, background: "rgba(12,20,15,.45)", zIndex: 65 }}
        >
          <div
            ...
            style={{
              ...
              width: 500,
              background: "#FBF7F0",
              boxShadow: "-28px 0 70px rgba(0,0,0,.30)",
              display: "flex",
              flexDirection: "column",
            }}
            data-testid="sender-drawer"
          >
            <div
              style={{
                background: "#fff",
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 12.5, color: "#9AA59E" }}>
                    Clientforce Mailer · {drawer.fromName ?? "—"}
                  </div>
                </div>
                <span
                  style={{
                    fontSize: 11,
                    fontWeight: 700,
                    color: drawer.status === "ACTIVE" ? "#0F7A28" : "#9A6B12",
                    background: drawer.status === "ACTIVE" ? "#D7F5DD" : "#FBEFD2",
                    borderRadius: 100,
                    padding: "4px 11px",
                  }}
                >
                  {drawer.status === "ACTIVE" ? "Active" : drawer.status}
                </span>
              </div>
              <div
                style={{
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 14 }}>
                  <span
                    style={{
                      ...
                      height: 58,
                      borderRadius: "50%",
                      border: `4px solid ${authPasses(drawer) === 3 ? "#16A82A" : "#E8C45B"}`,
                      background: "#fff",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      fontSize: 15,
                      fontWeight: 800,
                      color: authPasses(drawer) === 3 ? "#16A82A" : "#E8C45B",
                      flex: "none",
                    }}
                  >
                    {authPasses(drawer)}/3
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      {authPasses(drawer) === 3 ? "Auth checks pass" : "DNS needs attention"}
                    </div>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 5 }}>
                  ...
                  <span style={{ fontSize: 12, color: "#9AA59E" }}>
                    {drawer.sentToday} / {drawer.dailyLimit}
                  </span>
                </div>
                <div
                  style={{
                ...
                >
                  <div
                    style={{
                      height: "100%",
                      width: `${Math.min(100, Math.round((drawer.sentToday / Math.max(1, drawer.dailyLimit)) * 100))}%`,
                      background: authPasses(drawer) === 3 ? "#16A82A" : "#E8C45B",
                    }}
                  />
                </div>
              </div>
                ...
                <div style={{ display: "flex", alignItems: "center", marginBottom: 8 }}>
                  ...
                  <span
                    style={{
                      fontSize: 11,
                      fontWeight: 700,
                      color: drawer.warmupState ? "#9A6B12" : "#0F7A28",
                      background: drawer.warmupState ? "#FBEFD2" : "#D7F5DD",
                      borderRadius: 100,
                      padding: "4px 11px",
                    }}
                  >
                    {drawer.warmupState ? "In progress" : "Not needed"}
                  </span>
                </div>
                <div style={{ fontSize: 13.5, color: "#5C6B62" }}>
                  {drawer.warmupState
                    ? "Managed warm-up is ramping this sender's volume."
                    : "This managed sender sends at full volume."}
                </div>
              </div>
            </div>
            <div
            ...
            >
              <span
                title="Test sends run from Settings → Channels (P1.5)"
                style={{
                  fontSize: 13.5,
                  fontWeight: 600,
                  color: "#5C6B62",
              ...
              <span
                title="Pausing senders arrives with C2.6 Settings"
                style={{
                  marginLeft: "auto",
                  fontSize: 13.5,
                  fontWeight: 700,
          ...
          >
            ...
            >
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 12.5, color: "#9AA59E" }}>
                  Adjust caps per channel to protect deliverability.
                </div>
              </div>
              <span
                onClick={() => setVolumeOpen(false)}
            ...
            >
              ...
              >
                <span style={{ fontSize: 16 }}>✉</span>
                <span style={{ fontSize: 14, fontWeight: 600, color: "#0E1512", flex: 1 }}>
                  Email
                </span>
                <span
                  style={{
                ...
                >
                  <button
                    type="button"
                    onClick={() => setDailyCap((v) => Math.max(10, v - 10))}
                    style={{
                      width: 26,
                      height: 26,
                      borderRadius: "50%",
            ...
            >
              ...
              <span
                onClick={() => {
                  void saveGuardrails({ cap: dailyCap });
                  setVolumeOpen(false);
                }}
                style={{
                  marginLeft: "auto",
