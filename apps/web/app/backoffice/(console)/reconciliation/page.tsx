  ...
  return (
    <div>
      ...
      <p style={{ color: "#5b6560", fontSize: 14, margin: "0 0 20px", maxWidth: 720 }}>
        Our metered usage (from the event ledger) vs each provider invoice, per provider per month.
        This is the prerequisite for enforcing credits after one reconciled month — metrics we
        don&apos;t meter yet are shown honestly as <em>not metered</em>, never a fabricated match.
      </p>
        ...
        >
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
            ...
            <tbody>
              {rows.map((r, i) => (
                <tr
                  key={`${r.provider}-${r.metric}-${r.month}-${i}`}
