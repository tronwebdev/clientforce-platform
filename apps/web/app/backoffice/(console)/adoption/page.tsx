  ...
  return (
    <div>
      ...
      <p style={{ color: "#5b6560", fontSize: 14, margin: "0 0 18px", maxWidth: 720 }}>
        Product-adoption telemetry — ids and event names only, never message or contact content.
        Internal; excluded from tenant Analytics.
      </p>
        ...
        <>
          ...
          <div style={{ display: "flex", gap: 12, marginBottom: 24 }}>
            ...
            <Stat
              ...
              value={a.wau > 0 ? `${Math.round((a.dau / a.wau) * 100)}%` : "—"}
              muted={a.wau === 0}
            />
          </div>
          ...
          {a.featureAdoption.length === 0 ? (
            <div style={{ color: "#8a938d", fontSize: 13 }}>
              No feature-use events in this window.
            </div>
          ) : (
            <div
              style={{
