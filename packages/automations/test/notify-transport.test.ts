...
describe("notify_team transport seam", () => {
  ...
  it("wired transport: called with the rule-scoped dedupe key; delivery evidence rides the detail", async () => {
    ...
    expect(calls).toEqual([
      { workspaceId: "ws1", sourceKey: "evt-1#rule:rule-1", note: "Hot lead", contactId: "contact-1" },
    ]);
