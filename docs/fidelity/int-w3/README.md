...
| `proto-webhooks-wizard-events` | The canon events-pick step — the STREAM half deliberately NOT built (honest absence, re-filed → Q-054); shot as the canon record of what re-files. |
